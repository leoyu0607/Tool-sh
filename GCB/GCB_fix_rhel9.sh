...
if [ $flag_010 -eq 0 ] || [ $flag_011 -eq 0 ] || [ $flag_012 -eq 0 ]; then
    ...
    ' /etc/fstab > /etc/fstab.tmp && mv /etc/fstab.tmp /etc/fstab; then
        ...
        set_flag flag_011 1
        log_append "[TWGCB-01-012-0011][FIX] add nosuid option to /var/tmp in /etc/fstab"
        set_flag flag_012 1
        log_append "[TWGCB-01-012-0012][FIX] add noexec option to /var/tmp in /etc/fstab"
        ...
        set_flag flag_011 0
        log_append "[TWGCB-01-012-0011][ERROR] failed to update /etc/fstab for nosuid option on /var/tmp"
        set_flag flag_012 0
        log_append "[TWGCB-01-012-0012][ERROR] failed to update /etc/fstab for noexec option on /var/tmp"
    fi
fi
# ======================================
# TWGCB-01-012-0013
...
if [ $flag_013 -eq 0 ]; then
    set_flag flag_013 2
    log_append "[TWGCB-01-012-0013][IGNORE] 需要重建VM或擴充磁碟"
fi
# ======================================
# TWGCB-01-012-0014
...
if [ $flag_014 -eq 0 ]; then
    set_flag flag_014 2
    log_append "[TWGCB-01-012-0014][IGNORE] 需要重建VM或擴充磁碟"
fi
# ======================================
# TWGCB-01-012-0015
...
if [ $flag_015 -eq 0 ]; then
    set_flag flag_015 2
    log_append "[TWGCB-01-012-0015][IGNORE] 需要重建VM或擴充磁碟"
fi
# ======================================
# TWGCB-01-012-0016
# /home須設定nodev選項
if [ $flag_016 -eq 0 ]; then
    ...
    ' /etc/fstab > /etc/fstab.tmp && mv /etc/fstab.tmp /etc/fstab; then
        set_flag flag_016 1
        log_append "[TWGCB-01-012-0016][FIX] add nodev option to /home in /etc/fstab"
        mount -o remount,nodev "$mount_point" 2>/dev/null || true
    else
        set_flag flag_016 0
        log_append "[TWGCB-01-012-0016][ERROR] failed to update /etc/fstab for nodev option on /home"
    fi
fi
# ======================================
# TWGCB-01-012-0017
...
if [ $flag_017 -eq 0 ] || [ $flag_018 -eq 0 ] || [ $flag_019 -eq 0 ]; then
    ...
    set_flag flag_017 1
    log_append "[TWGCB-01-012-0017][FIX] add nodev option to /dev/shm in /etc/fstab"
    set_flag flag_018 1
    log_append "[TWGCB-01-012-0018][FIX] add nosuid option to /dev/shm in /etc/fstab"
    set_flag flag_019 1
    log_append "[TWGCB-01-012-0019][FIX] add noexec option to /dev/shm in /etc/fstab"
fi
# ======================================
# TWGCB-01-012-0020
# 可攜式儲存裝置須設定nodev選項
...
if [ $flag_020 -eq 0 ] || [ $flag_021 -eq 0 ] || [ $flag_022 -eq 0 ] || [ $flag_031 -eq 0 ]; then
    ...
    dracut -f
    set_flag flag_020 1
    log_append "[TWGCB-01-012-0020][FIX] disable usb-storage module to prevent portable storage devices"
    set_flag flag_021 1
    log_append "[TWGCB-01-012-0021][FIX] disable usb-storage module to prevent portable storage devices"
    set_flag flag_022 1
    log_append "[TWGCB-01-012-0022][FIX] disable usb-storage module to prevent portable storage devices"
    set_flag flag_031 1
    log_append "[TWGCB-01-012-0031][FIX] disable usb-storage module to prevent USB storage devices"
fi
# ======================================
# TWGCB-01-012-0023
# 使用者家目錄須設定nodev選項
...
if [ $flag_023 -eq 0 ] || [ $flag_024 -eq 0 ] || [ $flag_025 -eq 0 ]; then
    ...
    for mp in $submounts; do
        ...
        ' /etc/fstab > /etc/fstab.tmp && mv /etc/fstab.tmp /etc/fstab; then
            set_flag flag_023 1
            log_append "[TWGCB-01-012-0023][FIX] add nodev option to /home sub-mounts in /etc/fstab"
            set_flag flag_024 1
            log_append "[TWGCB-01-012-0024][FIX] add nosuid option to /home sub-mounts in /etc/fstab"
            set_flag flag_025 1
            log_append "[TWGCB-01-012-0025][IGNORE] 設定後影響服務使用"
        else
            set_flag flag_023 0
            log_append "[TWGCB-01-012-0023][ERROR] failed to update /etc/fstab for nodev option on /home sub-mounts"
            set_flag flag_024 0
            log_append "[TWGCB-01-012-0024][ERROR] failed to update /etc/fstab for nosuid option on /home sub-mounts"
            set_flag flag_025 0
            log_append "[TWGCB-01-012-0025][IGNORE] 設定後影響服務使用"
        fi
        mount -o remount,nodev,nosuid "$mp" 2>/dev/null || true
    done
fi
# ======================================
# TWGCB-01-012-0026
...
if [ $flag_026 -eq 0 ] || [ $flag_027 -eq 0 ] || [ $flag_028 -eq 0 ]; then
    ...
    for mp in $nfs_mounts; do
        ...
        ' /etc/fstab > /etc/fstab.tmp && mv /etc/fstab.tmp /etc/fstab; then
            set_flag flag_026 1
            log_append "[TWGCB-01-012-0026][FIX] add nodev option to NFS mount points in /etc/fstab"
            set_flag flag_027 1
            log_append "[TWGCB-01-012-0027][FIX] add nosuid option to NFS mount points in /etc/fstab"
            set_flag flag_028 1
            log_append "[TWGCB-01-012-0028][FIX] add noexec option to NFS mount points in /etc/fstab"
        else
            set_flag flag_026 0
            log_append "[TWGCB-01-012-0026][ERROR] failed to update /etc/fstab for nodev option on NFS mount points"
            set_flag flag_027 0
            log_append "[TWGCB-01-012-0027][ERROR] failed to update /etc/fstab for nosuid option on NFS mount points"
            set_flag flag_028 0
            log_append "[TWGCB-01-012-0028][ERROR] failed to update /etc/fstab for noexec option on NFS mount points"
        fi
...
if [ $flag_029 -eq 0 ]; then
    ...
    for dir in $dirs; do
        if chmod +t "$dir"; then
            set_flag flag_029 1
            log_append "[TWGCB-01-012-0029][FIX] set sticky bit on world-writable directory: $dir"
        else
            set_flag flag_029 0
            log_append "[TWGCB-01-012-0029][ERROR] failed to set sticky bit on world-writable directory: $dir"
        fi
    done
fi
# ======================================
...
if [ $flag_030 -eq 0 ]; then
    if systemctl disable --now autofs; then
        set_flag flag_030 1
        log_append "[TWGCB-01-012-0030][FIX] disable autofs service"
    else
        set_flag flag_030 0
        log_append "[TWGCB-01-012-0030][ERROR] failed to disable autofs service"
    fi
fi
# ======================================
# TWGCB-01-012-0031
# 需停用USB儲存裝置
# 已經在前面 TWGCB-01-012-0020 ~ TWGCB-01-012-0022 的修正中處理了
# ======================================
# TWGCB-01-012-0032
# 啟用GPG簽章驗證功能
if [ $flag_032 -eq 0 ]; then
    if [ -f /etc/dnf/dnf.conf ]; then
        ...
        log_append "[TWGCB-01-012-0032][ERROR] /etc/dnf/dnf.conf not found, cannot set global gpgcheck"
    fi
    shopt -s nullglob
    ...
    if [ ${#repo_files[@]} -eq 0 ]; then
        set_flag flag_032 0
        log_append "[TWGCB-01-012-0032][ERROR] No .repo files found in /etc/yum.repos.d/, cannot set repo gpgcheck"
    else
        for repo in "${repo_files[@]}"; do
            ...
            { print }
            END { if (in_section) ensure_defaults() }
            ' "$repo" > "${repo}.tmp" && mv -f "${repo}.tmp" "$repo"
        done
    fi
    set_flag flag_032 1
    log_append "[TWGCB-01-012-0032][FIX] enable GPG signature verification"
fi
# ======================================
# TWGCB-01-012-0033
# 需安裝sudo套件
if [ $flag_033 -eq 0 ]; then
    if dnf install -y sudo; then
        set_flag flag_033 1
        log_append "[TWGCB-01-012-0033][FIX] install sudo package"
    else
        set_flag flag_033 0
        log_append "[TWGCB-01-012-0033][ERROR] failed to install sudo package"
    fi
fi
# ======================================
# TWGCB-01-012-0034
...
if [ $flag_034 -eq 0 ]; then
    ...
    visudo -c
    set_flag flag_034 1
    log_append "[TWGCB-01-012-0034][FIX] set sudo to use pseudo terminal (pty)"
fi
# ======================================
# TWGCB-01-012-0035
...
if [ $flag_035 -eq 0 ]; then
    ...
    visudo -c
    set_flag flag_035 1
    log_append "[TWGCB-01-012-0035][FIX] set sudo custom log file to /var/log/sudo.log"
fi
# ======================================
# TWGCB-01-012-0036
# 安裝AIDE套件
if [ $flag_036 -eq 0 ]; then
    if dnf install -y aide --setopt=timeout=10 --setopt=retries=1 > /tmp/dnf_install.log 2>&1; then
        set_flag flag_036 1
        log_append "[TWGCB-01-012-0036][FIX] install AIDE package"
    else
        set_flag flag_036 0
        log_append "[TWGCB-01-012-0036][ERROR] failed to install AIDE package"
    fi
fi
# ======================================
# TWGCB-01-012-0037
...
if [ $flag_036 -eq 0 ]; then
    set_flag flag_037 2
    log_append "[TWGCB-01-012-0037][IGNORE] 需要先安裝AIDE套件"
elif [ $flag_036 -eq 1 ] && [ $flag_037 -eq 0 ]; then
    current="$(crontab -l 2>/dev/null || true)"
    (echo "$current"; echo "0 5 * * * /usr/sbin/aide --check > /var/log/aide-check.log 2>&1") | crontab -
    set_flag flag_037 1
    log_append "[TWGCB-01-012-0037][FIX] schedule regular file integrity checks with AIDE"
fi
# ======================================
# TWGCB-01-012-0038
...
if [ $flag_038 -eq 0 ] || [ $flag_039 -eq 0 ]; then
    files=(/boot/grub2/grub.cfg /boot/efi/EFI/rhel/grub.cfg /boot/grub2/user.cfg /boot/grub2/grubenv)
    for file in "${files[@]}"; do
        if [ -f "$file" ]; then
            chown root:root "$file"
            chmod 600 "$file"
            log_append "[TWGCB-01-012-0038][INFO] $file: set ownership root:root and permissions 600"
        fi
    done
    set_flag flag_038 1
    log_append "[TWGCB-01-012-0038][FIX] set ownership of boot loader config files to root:root"
    set_flag flag_039 1
    log_append "[TWGCB-01-012-0039][FIX] set permissions of boot loader config files to 600"
fi
# ======================================
# TWGCB-01-012-0040
# 開機載入程式之通行碼
if [ $flag_040 -eq 0 ]; then
    set_flag flag_040 2
    log_append "[TWGCB-01-012-0040][IGNORE] 影響後續維運，需要手動設定GRUB密碼，請參考官方文件進行設定"
fi
# ======================================
# TWGCB-01-012-0041
# 單一使用者模式需啟用身分鑑別功能
if [ $flag_041 -eq 0 ]; then
    if [ -f /etc/systemd/system/rescue.service ] || [ -f /etc/systemd/system/emergency.service ]; then
        ...
        log_append "[TWGCB-01-012-0041][INFO] removed override unit files in /etc/systemd/system/"
    fi
    if [ -d /etc/systemd/system/rescue.service.d ] || [ -d /etc/systemd/system/emergency.service.d ]; then
        ...
        log_append "[TWGCB-01-012-0041][INFO] removed drop-in overrides in /etc/systemd/system/*.service.d/"
    fi
    verify_rescue=0
    verify_emerg=0
    ...
    if [ $verify_rescue -ne 0 ] || [ $verify_emerg -ne 0 ]; then
        if dnf reinstall -y systemd --setopt=timeout=10 --setopt=retries=1 > /tmp/dnf_reinstall.log 2>&1; then
            log_append "[TWGCB-01-012-0041][INFO] reinstalled systemd to restore default rescue and emergency services"
        else
            log_append "[TWGCB-01-012-0041][ERROR] failed to reinstall systemd"
        fi
    else
        log_append "[TWGCB-01-012-0041][INFO] rescue and emergency services are intact"
    fi
    systemctl daemon-reload
    ok=1
    ...
    if [ $ok -eq 1 ]; then
        set_flag flag_041 1
        log_append "[TWGCB-01-012-0041][FIX] rescue and emergency services use systemd-sulogin-shell"
    else
        set_flag flag_041 0
        log_append "[TWGCB-01-012-0041][ERROR] rescue and emergency services do not use systemd-sulogin-shell, manual review required"
    fi
fi
...
if [ $flag_042 -eq 0 ]; then
    set_flag flag_042 2
    log_append "[TWGCB-01-012-0042][IGNORE] 影響Sipx服務使用，請評估後手動設定"
fi
# ======================================
# TWGCB-01-012-0043
...
if [ $flag_043 -eq 0 ]; then
    ...
    set_flag flag_043 1
    log_append "[TWGCB-01-012-0043][FIX] enable Address Space Layout Randomization (ASLR)"
fi
# ======================================
# TWGCB-01-012-0044
...
if [ $flag_044 -eq 0 ]; then
    if [ -f /etc/crypto-policies/config ]; then
        ...
        set_flag flag_044 1
        log_append "[TWGCB-01-012-0044][FIX] set system-wide crypto policy to FUTURE"
    else
        set_flag flag_044 0
        log_append "[TWGCB-01-012-0044][ERROR] /etc/crypto-policies/config not found, cannot set crypto policy"
    fi
fi
# ======================================
# TWGCB-01-012-0045
...
if [ $flag_045 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0045][FIX] /etc/passwd ownership set to root:root"
    set_flag flag_045 1
fi
# ======================================
# TWGCB-01-012-0046
...
if [ $flag_046 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0046][FIX] /etc/passwd permissions set to 644"
    set_flag flag_046 1
fi
# ======================================
# TWGCB-01-012-0047
...
if [ $flag_047 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0047][FIX] /etc/shadow ownership set to root:root"
    set_flag flag_047 1
fi
# ======================================
# TWGCB-01-012-0048
...
if [ $flag_048 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0048][FIX] /etc/shadow permissions set to 000"
    set_flag flag_048 1
fi
# ======================================
# TWGCB-01-012-0049
...
if [ $flag_049 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0049][FIX] /etc/group ownership set to root:root"
    set_flag flag_049 1
fi
# ======================================
# TWGCB-01-012-0050
...
if [ $flag_050 -eq 0 ]; then
    chmod 644 /etc/group
    log_append "[TWGCB-01-012-0050][FIX] /etc/group permissions set to 644"
    set_flag flag_050 1
fi
# ======================================
# TWGCB-01-012-0051
...
if [ $flag_051 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0051][FIX] /etc/gshadow ownership set to root:root"
    set_flag flag_051 1
fi
# ======================================
# TWGCB-01-012-0052
...
if [ $flag_052 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0052][FIX] /etc/gshadow permissions set to 000"
    set_flag flag_052 1
fi
# ======================================
# TWGCB-01-012-0053
...
if [ $flag_053 -eq 0 ]; then
    chown root:root /etc/passwd-
    log_append "[TWGCB-01-012-0053][FIX] /etc/passwd- ownership set to root:root"
    set_flag flag_053 1
fi
# ======================================
# TWGCB-01-012-0054
...
if [ $flag_054 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0054][FIX] /etc/passwd- permissions set to 600"
    set_flag flag_054 1
fi
# ======================================
# TWGCB-01-012-0055
...
if [ $flag_055 -eq 0 ]; then
    chown root:root /etc/shadow-
    log_append "[TWGCB-01-012-0055][FIX] /etc/shadow- ownership set to root:root"
    set_flag flag_055 1
fi
# ======================================
# TWGCB-01-012-0056
...
if [ $flag_056 -eq 0 ]; then
    chmod 000 /etc/shadow-
    log_append "[TWGCB-01-012-0056][FIX] /etc/shadow- permissions set to 000"
    set_flag flag_056 1
fi
# ======================================
# TWGCB-01-012-0057
...
if [ $flag_057 -eq 0 ]; then
    chown root:root /etc/group-
    log_append "[TWGCB-01-012-0057][FIX] /etc/group- ownership set to root:root"
    set_flag flag_057 1
fi
# ======================================
# TWGCB-01-012-0058
...
if [ $flag_058 -eq 0 ]; then
    chmod 644 /etc/group-
    log_append "[TWGCB-01-012-0058][FIX] /etc/group- permissions set to 644"
    set_flag flag_058 1
fi
# ======================================
# TWGCB-01-012-0059
...
if [ $flag_059 -eq 0 ]; then
    chown root:root /etc/gshadow-
    log_append "[TWGCB-01-012-0059][FIX] /etc/gshadow- ownership set to root:root"
    set_flag flag_059 1
fi
# ======================================
# TWGCB-01-012-0060
...
if [ $flag_060 -eq 0 ]; then
    chmod 000 /etc/gshadow-
    log_append "[TWGCB-01-012-0060][FIX] /etc/gshadow- permissions set to 000"
    set_flag flag_060 1
fi
# ======================================
# TWGCB-01-012-0061
...
if [ $flag_061 -eq 0 ]; then
    ...
    for file in $files; do
        if chmod o-w "$file"; then
            log_append "[TWGCB-01-012-0061][FIX] removed world-writable permission from file: $file"
            set_flag flag_061 1
        else
            log_append "[TWGCB-01-012-0061][ERROR] failed to remove world-writable permission from file: $file"
            set_flag flag_061 0
        fi
    done
fi
...
if [ $flag_062 -eq 0 ]; then
    if [ -s /tmp/gcb_062_invalid_uid_entries.txt ]; then
        ...
        while read -r uid user path; do
            [ -z "$path" ] && continue
            if [ ! -e "$path" ]; then
                log_append "[TWGCB-01-012-0062][ERROR] path not exists, skip: uid=$uid user=$user path=$path"
                fail=$((fail + 1))
                continue
            fi
            if chown root:root "$path"; then
                log_append "[TWGCB-01-012-0062][FIX] changed ownership of $path to root:root from uid=$uid user=$user"
            else
                log_append "[TWGCB-01-012-0062][ERROR] failed to change ownership of $path to root:root (uid=$uid)"
                fail=$((fail + 1))
            fi
        ...
        if [ $fail -eq 0 ]; then
            ...
            log_append "[TWGCB-01-012-0062][FIX] all invalid UID entries fixed"
        else
            log_append "[TWGCB-01-012-0062][ERROR] some invalid UID entries could not be fixed, please check the log"
            set_flag flag_062 0
        fi
    else
        set_flag flag_062 0
        log_append "[TWGCB-01-012-0062][ERROR] no invalid UID entries file found"
    fi
fi
# ======================================
# TWGCB-01-012-0063
...
if [ $flag_063 -eq 0 ]; then
    if [ -s /tmp/gcb_063_invalid_gid_entries.txt ]; then
        ...
        while read -r gid group path; do
            [ -z "$path" ] && continue
            if [ ! -e "$path" ]; then
                log_append "[TWGCB-01-012-0063][ERROR] path not exists, skip: gid=$gid group=$group path=$path"
                fail=$((fail + 1))
                continue
            fi
            if chown root:root "$path"; then
                log_append "[TWGCB-01-012-0063][INFO] changed ownership of $path to root:root from gid=$gid group=$group"
            else
                log_append "[TWGCB-01-012-0063][ERROR] failed to change ownership of $path to root:root (gid=$gid)"
                fail=$((fail + 1))
            fi
        ...
        if [ $fail -eq 0 ]; then
            ...
            log_append "[TWGCB-01-012-0063][FIX] all invalid GID entries fixed"
        else
            log_append "[TWGCB-01-012-0063][ERROR] some invalid GID entries could not be fixed, please check the log"
            set_flag flag_063 0
        fi
    else
        log_append "[TWGCB-01-012-0063][ERROR] no invalid GID entries file found"
        set_flag flag_063 0
    fi
fi
# ======================================
...
if [ $flag_064 -eq 0 ]; then
    if [ -s /tmp/gcb_064_invalid_world_writable_dirs.txt ]; then
        ...
        while read -r uid user path; do
            [ -z "$path" ] && continue
            if [ ! -d "$path" ]; then
                log_append "[TWGCB-01-012-0064][ERROR] path not exists, skip: uid=$uid user=$user path=$path"
                fail=$((fail + 1))
                continue
            fi
            if chown root:root "$path"; then
                log_append "[TWGCB-01-012-0064][INFO] changed ownership of $path to root:root from uid=$uid user=$user"
            else
                log_append "[TWGCB-01-012-0064][ERROR] failed to change ownership of $path to root:root (uid=$uid)"
                fail=$((fail + 1))
            fi
        done < /tmp/gcb_064_invalid_world_writable_dirs.txt
        if [ $fail -eq 0 ]; then
            rm -f /tmp/gcb_064_invalid_world_writable_dirs.txt
            log_append "[TWGCB-01-012-0064][FIX] all invalid world-writable directories fixed"
            set_flag flag_064 1
        else
            log_append "[TWGCB-01-012-0064][ERROR] some invalid world-writable directories could not be fixed, please check the log"
            set_flag flag_064 0
        fi
    else
        log_append "[TWGCB-01-012-0064][ERROR] no invalid world-writable directories file found"
        set_flag flag_064 0
    fi
fi
# ======================================
...
if [ $flag_065 -eq 0 ]; then
    if [ -s /tmp/gcb_065_invalid_world_writable_dirs_groups.txt ]; then
        ...
        while read -r gid group path; do
            [ -z "$path" ] && continue
            if [ ! -d "$path" ]; then
                log_append "[TWGCB-01-012-0065][ERROR] path not exists, skip: gid=$gid group=$group path=$path"
                fail=$((fail + 1))
                continue
            fi
            if chown root:root "$path"; then
                log_append "[TWGCB-01-012-0065][INFO] changed ownership of $path to root:root from gid=$gid group=$group"
            else
                log_append "[TWGCB-01-012-0065][ERROR] failed to change ownership of $path to root:root (gid=$gid)"
                fail=$((fail + 1))
            fi
        done < /tmp/gcb_065_invalid_world_writable_dirs_groups.txt
        if [ $fail -eq 0 ]; then
            rm -f /tmp/gcb_065_invalid_world_writable_dirs_groups.txt
            log_append "[TWGCB-01-012-0065][FIX] all invalid world-writable directories fixed"
            set_flag flag_065 1
        else
            log_append "[TWGCB-01-012-0065][ERROR] some invalid world-writable directories could not be fixed, please check the log"
            set_flag flag_065 0
        fi
    else
        log_append "[TWGCB-01-012-0065][ERROR] no invalid world-writable directories file found"
        set_flag flag_065 0
    fi
fi
# ======================================
...
if [ $flag_066 -eq 0 ]; then
    if [ -s /tmp/gcb_066_invalid_command_files.txt ]; then
        ...
        while read -r perm path; do
            [ -z "$path" ] && continue
            if [ ! -f "$path" ]; then
                log_append "[TWGCB-01-012-0066][ERROR] path not exists, skip: perm=$perm path=$path"
                fail=$((fail + 1))
                continue
            fi
            if chmod 755 "$path"; then
                log_append "[TWGCB-01-012-0066][INFO] changed permissions of $path to 755 from perm=$perm"
            else
                log_append "[TWGCB-01-012-0066][ERROR] failed to change permissions of $path to 755 (perm=$perm)"
                fail=$((fail + 1))
            fi
        done < /tmp/gcb_066_invalid_command_files.txt
        if [ $fail -eq 0 ]; then
            rm -f /tmp/gcb_066_invalid_command_files.txt
            log_append "[TWGCB-01-012-0066][FIX] all invalid command files fixed"
            set_flag flag_066 1
        else
            log_append "[TWGCB-01-012-0066][ERROR] some invalid command files could not be fixed, please check the log"
            set_flag flag_066 0
        fi
    else
        log_append "[TWGCB-01-012-0066][ERROR] no invalid command files file found"
        set_flag flag_066 0
    fi
fi
# ======================================
...
if [ $flag_067 -eq 0 ] || [ $flag_068 -eq 0 ]; then
    ...
    while read -r uid user gid group path; do
        [ -z "$path" ] && continue
        if [ ! -f "$path" ]; then
            log_append "[TWGCB-01-012-0067][ERROR] path not exists, skip: uid=$uid group=$group path=$path"
            log_append "[TWGCB-01-012-0068][ERROR] path not exists, skip: uid=$uid group=$group path=$path"
            continue
        fi
        if chown root:root "$path"; then
            log_append "[TWGCB-01-012-0067][INFO] changed ownership of $path to root:root from uid=$uid group=$group"
            log_append "[TWGCB-01-012-0068][INFO] changed ownership of $path to root:root from uid=$uid group=$group"
        else
            fail=$((fail + 1))
            log_append "[TWGCB-01-012-0067][ERROR] failed to change ownership of $path to root:root (uid=$uid group=$group)"
            log_append "[TWGCB-01-012-0068][ERROR] failed to change ownership of $path to root:root (uid=$uid group=$group)"
        fi
    done <<< "$invalid_command_files"
    if [ $fail -eq 0 ]; then
        log_append "[TWGCB-01-012-0067][FIX] all invalid command files fixed"
        log_append "[TWGCB-01-012-0068][FIX] all invalid command files fixed"
        set_flag flag_067 1
        set_flag flag_068 1
    else
        log_append "[TWGCB-01-012-0067][ERROR] some invalid command files could not be fixed, please check the log"
        log_append "[TWGCB-01-012-0068][ERROR] some invalid command files could not be fixed, please check the log"
        set_flag flag_067 0
        set_flag flag_068 0
    fi
fi
...
if [ $flag_069 -eq 0 ]; then
    if [ -s /tmp/gcb_069_invalid_library_files.txt ]; then
        ...
        while read -r perm path; do
            [ -z "$path" ] && continue
            if [ ! -f "$path" ]; then
                log_append "[TWGCB-01-012-0069][ERROR] path not exists, skip: perm=$perm path=$path"
                fail=$((fail + 1))
                continue
            fi
            if chmod 755 "$path"; then
                log_append "[TWGCB-01-012-0069][INFO] changed permissions of $path to 755 from perm=$perm"
            else
                log_append "[TWGCB-01-012-0069][ERROR] failed to change permissions of $path to 755 (perm=$perm)"
                fail=$((fail + 1))
            fi
        done < /tmp/gcb_069_invalid_library_files.txt
        if [ $fail -eq 0 ]; then
            rm -f /tmp/gcb_069_invalid_library_files.txt
            log_append "[TWGCB-01-012-0069][FIX] all invalid library files fixed"
            set_flag flag_069 1
        else
            log_append "[TWGCB-01-012-0069][ERROR] some invalid library files could not be fixed, please check the log"
            set_flag flag_069 0
        fi
    else
        log_append "[TWGCB-01-012-0069][ERROR] no invalid library files file found"
        set_flag flag_069 0
    fi
fi
# ======================================
...
if [ $flag_070 -eq 0 ] || [ $flag_071 -eq 0 ]; then
    ...
    while read -r uid user gid group path; do
        [ -z "$path" ] && continue
        if [ ! -f "$path" ]; then
            log_append "[TWGCB-01-012-0070][ERROR] path not exists, skip: uid=$uid group=$group path=$path"
            log_append "[TWGCB-01-012-0071][ERROR] path not exists, skip: uid=$uid group=$group path=$path"
            continue
        fi
        if chown root:root "$path"; then
            log_append "[TWGCB-01-012-0070][INFO] changed ownership of $path to root:root from uid=$uid group=$group"
            log_append "[TWGCB-01-012-0071][INFO] changed ownership of $path to root:root from uid=$uid group=$group"
        else
            fail=$((fail + 1))
            log_append "[TWGCB-01-012-0070][ERROR] failed to change ownership of $path to root:root (uid=$uid group=$group)"
            log_append "[TWGCB-01-012-0071][ERROR] failed to change ownership of $path to root:root (uid=$uid group=$group)"
        fi
    done <<< "$invalid_library_files"
    if [ $fail -eq 0 ]; then
        log_append "[TWGCB-01-012-0070][FIX] all invalid library files fixed"
        log_append "[TWGCB-01-012-0071][FIX] all invalid library files fixed"
        set_flag flag_070 1
        set_flag flag_071 1
    else
        log_append "[TWGCB-01-012-0070][ERROR] some invalid library files could not be fixed, please check the log"
        log_append "[TWGCB-01-012-0071][ERROR] some invalid library files could not be fixed, please check the log"
        set_flag flag_070 0
        set_flag flag_071 0
    fi
fi
...
if [ $flag_072 -eq 0 ]; then
    ...
    for user in $empty_password_users; do
        if passwd -l "$user"; then
            log_append "[TWGCB-01-012-0072][FIX] locked account with empty password: $user"
        else
            log_append "[TWGCB-01-012-0072][ERROR] failed to lock account: $user"
            fail=$((fail + 1))
        fi
    done
    if [ $fail -eq 0 ]; then
...
# GCB TWGCB-01-012-0073: ensure root PATH contains only absolute paths
if [ "$(id -u)" -eq 0 ]; then
...
EOF
    ...
    set_flag flag_073 1
    log_append "[TWGCB-01-012-0073][FIX] set secure PATH for root in $profile_file"
fi
# ======================================
# TWGCB-01-012-0074
        ...
        if [ -d "$dir" ]; then
            ...
            if [ $(( 8#${perms: -3} & 8#020 )) -ne 0 ]; then
                if chmod g-w "$dir"; then
                    log_append "[TWGCB-01-012-0074][FIX] removed group-write permission from PATH directory: $dir"
                else
                    log_append "[TWGCB-01-012-0074][ERROR] failed to remove group-write from: $dir"
                    fail=$((fail + 1))
                fi
            fi
            if [ $(( 8#${perms: -3} & 8#002 )) -ne 0 ]; then
                if chmod o-w "$dir"; then
                    log_append "[TWGCB-01-012-0074][FIX] removed world-write permission from PATH directory: $dir"
                else
                    log_append "[TWGCB-01-012-0074][ERROR] failed to remove world-write from: $dir"
                    fail=$((fail + 1))
                fi
            fi
        fi
...
if [ $flag_075 -eq 0 ]; then
    ...
    if sed -i '/^\+:/d' /etc/passwd; then
        set_flag flag_075 1
        log_append "[TWGCB-01-012-0075][FIX] removed '+' entries from /etc/passwd"
    else
        set_flag flag_075 0
        log_append "[TWGCB-01-012-0075][ERROR] failed to remove '+' entries from /etc/passwd"
    fi
fi
# ======================================
# TWGCB-01-012-0076
...
if [ $flag_076 -eq 0 ]; then
    ...
    if sed -i '/^\+:/d' /etc/shadow; then
        set_flag flag_076 1
        log_append "[TWGCB-01-012-0076][FIX] removed '+' entries from /etc/shadow"
    else
        set_flag flag_076 0
        log_append "[TWGCB-01-012-0076][ERROR] failed to remove '+' entries from /etc/shadow"
    fi
fi
# ======================================
# TWGCB-01-012-0077
...
if [ $flag_077 -eq 0 ]; then
    ...
    if sed -i '/^\+:/d' /etc/group; then
        set_flag flag_077 1
        log_append "[TWGCB-01-012-0077][FIX] removed '+' entries from /etc/group"
    else
        set_flag flag_077 0
        log_append "[TWGCB-01-012-0077][ERROR] failed to remove '+' entries from /etc/group"
    fi
fi
# ======================================
# TWGCB-01-012-0078
...
if [ $flag_078 -eq 0 ]; then
    ...
    for account in $uid0_accounts; do
        ...
        if usermod -u "$new_uid" "$account"; then
            log_append "[TWGCB-01-012-0078][FIX] changed UID of $account from 0 to $new_uid (files under home dir may need re-owning)"
        else
            log_append "[TWGCB-01-012-0078][ERROR] failed to change UID of $account"
            fail=$((fail + 1))
        fi
    done
    if [ $fail -eq 0 ]; then
    ...
    while IFS=: read -r username _ _ _ _ home shell; do
        ...
        if [ $(( 8#${perm: -3} & 8#077 )) -ne 0 ]; then
            if chmod 700 "$home"; then
                log_append "[TWGCB-01-012-0079][FIX] changed permissions of $home (user: $username) from $perm to 700"
            else
                log_append "[TWGCB-01-012-0079][ERROR] failed to change permissions of $home (user: $username)"
                fail=$((fail + 1))
            fi
        fi
    done < /etc/passwd
    ...
    while IFS=: read -r username _ _ _ _ home shell; do
        ...
        if [ "$owner" != "$username" ]; then
            if chown "$username" "$home"; then
                log_append "[TWGCB-01-012-0080][FIX] changed owner of $home from $owner to $username"
            else
                log_append "[TWGCB-01-012-0080][ERROR] failed to change owner of $home to $username"
                fail=$((fail + 1))
            fi
        fi
    done < /etc/passwd
    ...
    while IFS=: read -r username _ uid gid _ home shell; do
        ...
        if [ "$owner_gid" != "$gid" ]; then
            if chgrp "$gid" "$home"; then
                log_append "[TWGCB-01-012-0081][FIX] changed group of $home from GID $owner_gid to GID $gid (user: $username)"
            else
                log_append "[TWGCB-01-012-0081][ERROR] failed to change group of $home to GID $gid (user: $username)"
                fail=$((fail + 1))
            fi
        fi
    done < /etc/passwd
        ...
        for dotfile in "$home"/.[A-Za-z0-9]*; do
            ...
            if [ $need_fix -eq 1 ]; then
                if chmod go-w "$dotfile"; then
                    log_append "[TWGCB-01-012-0082][FIX] removed group/other write permission from $dotfile (user: $username)"
                else
                    log_append "[TWGCB-01-012-0082][ERROR] failed to chmod $dotfile (user: $username)"
                    fail=$((fail + 1))
                fi
            fi
        done
    ...
    while IFS=: read -r username _ _ _ _ home shell; do
        ...
        if [ ! -h "$home/.forward" ] && [ -f "$home/.forward" ]; then
            if rm -f "$home/.forward"; then
                log_append "[TWGCB-01-012-0083][FIX] removed .forward file: $home/.forward (user: $username)"
            else
                log_append "[TWGCB-01-012-0083][ERROR] failed to remove $home/.forward (user: $username)"
                fail=$((fail + 1))
            fi
        fi
    done < /etc/passwd
    ...
    while IFS=: read -r username _ _ _ _ home shell; do
        ...
        if [ ! -h "$home/.netrc" ] && [ -f "$home/.netrc" ]; then
            if rm -f "$home/.netrc"; then
                log_append "[TWGCB-01-012-0084][FIX] removed .netrc file: $home/.netrc (user: $username)"
            else
                log_append "[TWGCB-01-012-0084][ERROR] failed to remove $home/.netrc (user: $username)"
                fail=$((fail + 1))
            fi
        fi
    done < /etc/passwd
    ...
    while IFS=: read -r username _ _ _ _ home shell; do
        ...
        if [ ! -h "$home/.rhosts" ] && [ -f "$home/.rhosts" ]; then
            if rm -f "$home/.rhosts"; then
                log_append "[TWGCB-01-012-0085][FIX] removed .rhosts file: $home/.rhosts (user: $username)"
            else
                log_append "[TWGCB-01-012-0085][ERROR] failed to remove $home/.rhosts (user: $username)"
                fail=$((fail + 1))
            fi
        fi
    done < /etc/passwd
    ...
    while IFS= read -r gid; do
        if ! grep -q -P "^[^:]*:[^:]*:${gid}:" /etc/group; then
            ...
            if groupadd -g "$gid" "$grp_name" 2>/dev/null; then
                log_append "[TWGCB-01-012-0086][FIX] created group $grp_name with GID $gid (referenced in /etc/passwd but missing from /etc/group)"
            else
                log_append "[TWGCB-01-012-0086][ERROR] failed to create group for GID $gid - please manually run: groupadd -g $gid <groupname>"
                fail=$((fail + 1))
            fi
        fi
            ...
            while IFS=: read -r uname _ u_uid _; do
                if [ "$u_uid" = "$uid" ]; then
                    ...
                    if usermod -u "$new_uid" "$uname"; then
                        log_append "[TWGCB-01-012-0087][FIX] changed UID of $uname from $uid to $new_uid (duplicate UID resolved)"
                    else
                        log_append "[TWGCB-01-012-0087][ERROR] failed to change UID of $uname"
                        fail=$((fail + 1))
                    fi
                fi
            done < /etc/passwd
        ...
        while IFS=: read -r grp_name _ g_gid _; do
            if [ "$g_gid" = "$gid" ]; then
                ...
                if groupmod -g "$new_gid" "$grp_name"; then
                    log_append "[TWGCB-01-012-0088][FIX] changed GID of group $grp_name from $gid to $new_gid (duplicate GID resolved)"
                else
                    log_append "[TWGCB-01-012-0088][ERROR] failed to change GID of group $grp_name"
                    fail=$((fail + 1))
                fi
            fi
        done < /etc/group
...
if [ $flag_089 -eq 0 ]; then
    while IFS= read -r uname; do
        log_append "[TWGCB-01-012-0089][ERROR] Duplicate username ($uname) requires manual intervention: edit /etc/passwd to assign unique names"
...
if [ $flag_090 -eq 0 ]; then
    while IFS= read -r gname; do
        log_append "[TWGCB-01-012-0090][ERROR] Duplicate group name ($gname) requires manual intervention: edit /etc/group to assign unique names"
...
if [ $flag_091 -eq 0 ]; then
    ...
    if sed -ri 's/(^shadow:[^:]*:[^:]*:)([^:]+$)/\1/' /etc/group; then
        set_flag flag_091 1
        log_append "[TWGCB-01-012-0091][FIX] removed all members from shadow group in /etc/group"
    else
        set_flag flag_091 0
        log_append "[TWGCB-01-012-0091][ERROR] failed to remove members from shadow group"
    fi
fi
...
if [ $flag_092 -eq 0 ]; then
    if dnf remove -y xinetd; then
        set_flag flag_092 1
        log_append "[TWGCB-01-012-0092][FIX] removed xinetd package"
    else
        set_flag flag_092 0
        log_append "[TWGCB-01-012-0092][ERROR] failed to remove xinetd package"
    fi
fi
# ======================================
# TWGCB-01-012-0093
...
if [ $flag_093 -eq 0 ]; then
    if [ -f /etc/chrony.conf ]; then
        ...
        set_flag flag_093 1
        log_append "[TWGCB-01-012-0093][FIX] added default NTP pool (pool 2.rhel.pool.ntp.org iburst) to /etc/chrony.conf - please update to your organization's NTP server"
        systemctl restart chronyd 2>/dev/null || true
    else
        set_flag flag_093 0
        log_append "[TWGCB-01-012-0093][ERROR] /etc/chrony.conf not found; install chrony and configure NTP server manually"
    fi
fi
# ======================================
# TWGCB-01-012-0094
...
if [ $flag_094 -eq 0 ]; then
    if systemctl --now mask rsyncd; then
        set_flag flag_094 1
        log_append "[TWGCB-01-012-0094][FIX] masked rsyncd service"
    else
        set_flag flag_094 0
        log_append "[TWGCB-01-012-0094][ERROR] failed to mask rsyncd service"
    fi
fi
# ======================================
# TWGCB-01-012-0095
...
if [ $flag_095 -eq 0 ]; then
    if systemctl --now mask avahi-daemon.service 2>/dev/null; then
        log_append "[TWGCB-01-012-0095][FIX] masked avahi-daemon.service"
    else
        log_append "[TWGCB-01-012-0095][INFO] avahi-daemon.service not found or already masked"
    fi
    if systemctl --now mask avahi-daemon.socket 2>/dev/null; then
        log_append "[TWGCB-01-012-0095][FIX] masked avahi-daemon.socket"
    else
        log_append "[TWGCB-01-012-0095][INFO] avahi-daemon.socket not found or already masked"
    fi
    set_flag flag_095 1
fi
# ======================================
...
if [ $flag_096 -eq 0 ]; then
    if systemctl --now mask snmpd; then
        set_flag flag_096 1
        log_append "[TWGCB-01-012-0096][FIX] masked snmpd service"
    else
        set_flag flag_096 0
        log_append "[TWGCB-01-012-0096][ERROR] failed to mask snmpd service"
    fi
fi
# ======================================
# TWGCB-01-012-0097
...
if [ $flag_097 -eq 0 ]; then
    if systemctl --now mask squid; then
        set_flag flag_097 1
        log_append "[TWGCB-01-012-0097][FIX] masked squid service"
    else
        set_flag flag_097 0
        log_append "[TWGCB-01-012-0097][ERROR] failed to mask squid service"
    fi
fi
# ======================================
# TWGCB-01-012-0098
...
if [ $flag_098 -eq 0 ]; then
    if systemctl --now mask smb; then
        set_flag flag_098 1
        log_append "[TWGCB-01-012-0098][FIX] masked smb (Samba) service"
    else
        set_flag flag_098 0
        log_append "[TWGCB-01-012-0098][ERROR] failed to mask smb service"
    fi
fi
# ======================================
# TWGCB-01-012-0099
...
if [ $flag_099 -eq 0 ]; then
    if systemctl --now mask vsftpd; then
        set_flag flag_099 1
        log_append "[TWGCB-01-012-0099][FIX] masked vsftpd (FTP server) service"
    else
        set_flag flag_099 0
        log_append "[TWGCB-01-012-0099][ERROR] failed to mask vsftpd service"
    fi
fi
# ======================================
# TWGCB-01-012-0100
...
if [ $flag_100 -eq 0 ]; then
    if systemctl --now mask ypserv; then
        set_flag flag_100 1
        log_append "[TWGCB-01-012-0100][FIX] masked ypserv (NIS server) service"
    else
        set_flag flag_100 0
        log_append "[TWGCB-01-012-0100][ERROR] failed to mask ypserv service"
    fi
fi
# ======================================
# TWGCB-01-012-0101
...
if [ $flag_101 -eq 0 ]; then
    if systemctl --now enable kdump.service; then
        set_flag flag_101 1
        log_append "[TWGCB-01-012-0101][FIX] enabled kdump.service"
    else
        set_flag flag_101 0
        log_append "[TWGCB-01-012-0101][ERROR] failed to enable kdump.service"
    fi
fi
...
if [ $flag_102 -eq 0 ]; then
    if dnf remove -y ypbind; then
        set_flag flag_102 1
        log_append "[TWGCB-01-012-0102][FIX] removed ypbind (NIS client) package"
    else
        set_flag flag_102 0
        log_append "[TWGCB-01-012-0102][ERROR] failed to remove ypbind package"
    fi
fi
# ======================================
# TWGCB-01-012-0103
...
if [ $flag_103 -eq 0 ]; then
    if dnf remove -y telnet; then
        set_flag flag_103 1
        log_append "[TWGCB-01-012-0103][FIX] removed telnet client package"
    else
        set_flag flag_103 0
        log_append "[TWGCB-01-012-0103][ERROR] failed to remove telnet package"
    fi
fi
# ======================================
# TWGCB-01-012-0104
...
if [ $flag_104 -eq 0 ]; then
    if dnf remove -y telnet-server; then
        set_flag flag_104 1
        log_append "[TWGCB-01-012-0104][FIX] removed telnet-server package"
    else
        set_flag flag_104 0
        log_append "[TWGCB-01-012-0104][ERROR] failed to remove telnet-server package"
    fi
fi
# ======================================
# TWGCB-01-012-0105
...
if [ $flag_105 -eq 0 ]; then
    if dnf remove -y rsh-server; then
        set_flag flag_105 1
        log_append "[TWGCB-01-012-0105][FIX] removed rsh-server package"
    else
        set_flag flag_105 0
        log_append "[TWGCB-01-012-0105][ERROR] failed to remove rsh-server package"
    fi
fi
# ======================================
# TWGCB-01-012-0106
...
if [ $flag_106 -eq 0 ]; then
    if dnf remove -y tftp-server; then
        set_flag flag_106 1
        log_append "[TWGCB-01-012-0106][FIX] removed tftp-server package"
    else
        set_flag flag_106 0
        log_append "[TWGCB-01-012-0106][ERROR] failed to remove tftp-server package"
    fi
fi
# ======================================
# TWGCB-01-012-0107
...
if [ $flag_107 -eq 0 ]; then
    ...
    for conf in /etc/yum.conf /etc/dnf/dnf.conf; do
        ...
        if grep -qiE '^\s*clean_requirements_on_remove\s*=\s*[Tt]rue' "$conf"; then
            log_append "[TWGCB-01-012-0107][FIX] set clean_requirements_on_remove=True in $conf"
        else
            log_append "[TWGCB-01-012-0107][ERROR] failed to set clean_requirements_on_remove in $conf"
            fail=$((fail + 1))
        fi
    done
    if [ $fail -eq 0 ]; then set_flag flag_107 1; else set_flag flag_107 0; fi
fi
# ======================================
# TWGCB-01-012-0108
...
if [ $flag_108 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0108][FIX] set net.ipv4.ip_forward=0"
    ...
    log_append "[TWGCB-01-012-0108][FIX] set net.ipv6.conf.all.forwarding=0"
    if [ $fail -eq 0 ]; then set_flag flag_108 1; else set_flag flag_108 0; fi
fi
# ======================================
# TWGCB-01-012-0109
...
if [ $flag_109 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.all.send_redirects=0 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_109 1
        log_append "[TWGCB-01-012-0109][FIX] set net.ipv4.conf.all.send_redirects=0"
    else
        set_flag flag_109 0
        log_append "[TWGCB-01-012-0109][ERROR] failed to apply net.ipv4.conf.all.send_redirects=0"
    fi
fi
# ======================================
# TWGCB-01-012-0110
...
if [ $flag_110 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.default.send_redirects=0 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_110 1
        log_append "[TWGCB-01-012-0110][FIX] set net.ipv4.conf.default.send_redirects=0"
    else
        set_flag flag_110 0
        log_append "[TWGCB-01-012-0110][ERROR] failed to apply net.ipv4.conf.default.send_redirects=0"
    fi
fi
# ======================================
# TWGCB-01-012-0111
...
if [ $flag_111 -eq 0 ]; then
    ...
    log_append "[TWGCB-01-012-0111][FIX] set accept_source_route=0 for all interfaces"
...
if [ $flag_112 -eq 0 ]; then
    ...
    sysctl -w net.ipv4.route.flush=1; sysctl -w net.ipv6.route.flush=1 2>/dev/null || true
    log_append "[TWGCB-01-012-0112][FIX] set accept_source_route=0 for default interfaces"
...
if [ $flag_113 -eq 0 ]; then
    ...
    sysctl -w net.ipv4.route.flush=1; sysctl -w net.ipv6.route.flush=1 2>/dev/null || true
    log_append "[TWGCB-01-012-0113][FIX] set accept_redirects=0 for all interfaces"
...
if [ $flag_114 -eq 0 ]; then
    ...
    sysctl -w net.ipv4.route.flush=1; sysctl -w net.ipv6.route.flush=1 2>/dev/null || true
    log_append "[TWGCB-01-012-0114][FIX] set accept_redirects=0 for default interfaces"
...
if [ $flag_115 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.all.secure_redirects=0 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_115 1
        log_append "[TWGCB-01-012-0115][FIX] set net.ipv4.conf.all.secure_redirects=0"
    else
        set_flag flag_115 0
        log_append "[TWGCB-01-012-0115][ERROR] failed to apply net.ipv4.conf.all.secure_redirects=0"
    fi
fi
# ======================================
# TWGCB-01-012-0116
...
if [ $flag_116 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.default.secure_redirects=0 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_116 1
        log_append "[TWGCB-01-012-0116][FIX] set net.ipv4.conf.default.secure_redirects=0"
    else
        set_flag flag_116 0
        log_append "[TWGCB-01-012-0116][ERROR] failed to apply net.ipv4.conf.default.secure_redirects=0"
    fi
fi
# ======================================
# TWGCB-01-012-0117
...
if [ $flag_117 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.all.log_martians=1 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_117 1
        log_append "[TWGCB-01-012-0117][FIX] set net.ipv4.conf.all.log_martians=1"
    else
        set_flag flag_117 0
        log_append "[TWGCB-01-012-0117][ERROR] failed to apply net.ipv4.conf.all.log_martians=1"
    fi
fi
# ======================================
# TWGCB-01-012-0118
...
if [ $flag_118 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.default.log_martians=1 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_118 1
        log_append "[TWGCB-01-012-0118][FIX] set net.ipv4.conf.default.log_martians=1"
    else
        set_flag flag_118 0
        log_append "[TWGCB-01-012-0118][ERROR] failed to apply net.ipv4.conf.default.log_martians=1"
    fi
fi
# ======================================
# TWGCB-01-012-0119
...
if [ $flag_119 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.icmp_echo_ignore_broadcasts=1 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_119 1
        log_append "[TWGCB-01-012-0119][FIX] set net.ipv4.icmp_echo_ignore_broadcasts=1"
    else
        set_flag flag_119 0
        log_append "[TWGCB-01-012-0119][ERROR] failed to apply net.ipv4.icmp_echo_ignore_broadcasts=1"
    fi
fi
# ======================================
# TWGCB-01-012-0120
...
if [ $flag_120 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.icmp_ignore_bogus_error_responses=1 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_120 1
        log_append "[TWGCB-01-012-0120][FIX] set net.ipv4.icmp_ignore_bogus_error_responses=1"
    else
        set_flag flag_120 0
        log_append "[TWGCB-01-012-0120][ERROR] failed to apply net.ipv4.icmp_ignore_bogus_error_responses=1"
    fi
fi
# ======================================
# TWGCB-01-012-0121
...
if [ $flag_121 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.all.rp_filter=1 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_121 1
        log_append "[TWGCB-01-012-0121][FIX] set net.ipv4.conf.all.rp_filter=1"
    else
        set_flag flag_121 0
        log_append "[TWGCB-01-012-0121][ERROR] failed to apply net.ipv4.conf.all.rp_filter=1"
    fi
fi
# ======================================
# TWGCB-01-012-0122
...
if [ $flag_122 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.conf.default.rp_filter=1 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_122 1
        log_append "[TWGCB-01-012-0122][FIX] set net.ipv4.conf.default.rp_filter=1"
    else
        set_flag flag_122 0
        log_append "[TWGCB-01-012-0122][ERROR] failed to apply net.ipv4.conf.default.rp_filter=1"
    fi
fi
# ======================================
# TWGCB-01-012-0123
...
if [ $flag_123 -eq 0 ]; then
    ...
    if sysctl -w net.ipv4.tcp_syncookies=1 && sysctl -w net.ipv4.route.flush=1; then
        set_flag flag_123 1
        log_append "[TWGCB-01-012-0123][FIX] set net.ipv4.tcp_syncookies=1"
    else
        set_flag flag_123 0
        log_append "[TWGCB-01-012-0123][ERROR] failed to apply net.ipv4.tcp_syncookies=1"
    fi
fi
# ======================================
# TWGCB-01-012-0124
...
if [ $flag_124 -eq 0 ]; then
    ...
    if sysctl -w net.ipv6.conf.all.accept_ra=0 && sysctl -w net.ipv6.route.flush=1 2>/dev/null; then
        set_flag flag_124 1
        log_append "[TWGCB-01-012-0124][FIX] set net.ipv6.conf.all.accept_ra=0"
    else
        set_flag flag_124 0
        log_append "[TWGCB-01-012-0124][ERROR] failed to apply net.ipv6.conf.all.accept_ra=0"
    fi
fi
# ======================================
# TWGCB-01-012-0125
...
if [ $flag_125 -eq 0 ]; then
    ...
    if sysctl -w net.ipv6.conf.default.accept_ra=0 && sysctl -w net.ipv6.route.flush=1 2>/dev/null; then
        set_flag flag_125 1
        log_append "[TWGCB-01-012-0125][FIX] set net.ipv6.conf.default.accept_ra=0"
    else
        set_flag flag_125 0
        log_append "[TWGCB-01-012-0125][ERROR] failed to apply net.ipv6.conf.default.accept_ra=0"
    fi
fi
# ======================================
# TWGCB-01-012-0126
...
if [ $flag_126 -eq 0 ]; then
    ...
    set_flag flag_126 1
    log_append "[TWGCB-01-012-0126][FIX] disabled dccp module via $conf (reboot required)"
fi
# ======================================
# TWGCB-01-012-0127
# SCTP協定須停用
if [ $flag_127 -eq 0 ]; then
    ...
    set_flag flag_127 1
    log_append "[TWGCB-01-012-0127][FIX] disabled sctp module via $conf (reboot required)"
fi
# ======================================
# TWGCB-01-012-0128
# RDS協定須停用
if [ $flag_128 -eq 0 ]; then
    ...
    set_flag flag_128 1
    log_append "[TWGCB-01-012-0128][FIX] disabled rds module via $conf (reboot required)"
fi
# ======================================
# TWGCB-01-012-0129
# TIPC協定須停用
if [ $flag_129 -eq 0 ]; then
    ...
    set_flag flag_129 1
    log_append "[TWGCB-01-012-0129][FIX] disabled tipc module via $conf (reboot required)"
fi
# ======================================
# TWGCB-01-012-0130
# 無線網路介面須停用
if [ $flag_130 -eq 0 ]; then
    ...
    if [ -z "$wireless_dirs" ]; then
        set_flag flag_130 1
        log_append "[TWGCB-01-012-0130][FIX] No wireless interfaces found"
    elif command -v nmcli &>/dev/null; then
        if nmcli radio all off; then
            set_flag flag_130 1
            log_append "[TWGCB-01-012-0130][FIX] disabled all wireless interfaces via nmcli"
        else
            set_flag flag_130 0
            log_append "[TWGCB-01-012-0130][ERROR] failed to disable wireless via nmcli"
        fi
    else
        ...
        set_flag flag_130 1
        log_append "[TWGCB-01-012-0130][FIX] blacklisted wireless drivers in $conf (reboot required)"
    fi
fi
# ======================================
# TWGCB-01-012-0131
...
if [ $flag_131 -eq 0 ]; then
    ...
    ip link 2>/dev/null | grep -i promisc | awk -F': ' '{print $2}' | while read -r iface; do
        ...
        if ip link set dev "$iface_clean" promisc off 2>/dev/null; then
            log_append "[TWGCB-01-012-0131][FIX] disabled promiscuous mode on interface: $iface_clean"
        else
            log_append "[TWGCB-01-012-0131][ERROR] failed to disable promisc on: $iface_clean"
            fail=$((fail + 1))
        fi
    done
...
if [ $flag_132 -eq 0 ]; then
    if dnf install -y audit audit-libs; then
        set_flag flag_132 1
        log_append "[TWGCB-01-012-0132][FIX] installed audit and audit-libs packages"
    else
        set_flag flag_132 0
        log_append "[TWGCB-01-012-0132][ERROR] failed to install audit/audit-libs packages"
    fi
fi
# ======================================
# TWGCB-01-012-0133
...
if [ $flag_133 -eq 0 ]; then
    if systemctl --now enable auditd; then
        set_flag flag_133 1
        log_append "[TWGCB-01-012-0133][FIX] enabled and started auditd service"
    else
        set_flag flag_133 0
        log_append "[TWGCB-01-012-0133][ERROR] failed to enable auditd service"
    fi
fi
# ======================================
# TWGCB-01-012-0134
...
if [ $flag_134 -eq 0 ]; then
    if [ -f /etc/default/grub ]; then
        ...
        set_flag flag_134 1
        log_append "[TWGCB-01-012-0134][FIX] added audit=1 to GRUB_CMDLINE_LINUX (reboot required)"
    else
        set_flag flag_134 0
        log_append "[TWGCB-01-012-0134][ERROR] /etc/default/grub not found"
    fi
fi
# ======================================
# TWGCB-01-012-0135
...
if [ $flag_135 -eq 0 ]; then
    if [ -f /etc/default/grub ]; then
        ...
        grub2-mkconfig -o /boot/grub2/grub.cfg 2>/dev/null || \
            grub2-mkconfig -o /boot/efi/EFI/redhat/grub.cfg 2>/dev/null
        set_flag flag_135 1
        log_append "[TWGCB-01-012-0135][FIX] set audit_backlog_limit=8192 in GRUB_CMDLINE_LINUX (reboot required)"
    else
        set_flag flag_135 0
        log_append "[TWGCB-01-012-0135][ERROR] /etc/default/grub not found"
    fi
fi
# ======================================
# TWGCB-01-012-0136
...
if [ $flag_136 -eq 0 ]; then
    ...
    set_flag flag_136 1
    log_append "[TWGCB-01-012-0136][FIX] set postmaster: root in /etc/aliases"
fi
# ======================================
...
if [ $flag_137 -eq 0 ]; then
    if [ -f "$audit_log_file" ]; then
        if chown root:root "$audit_log_file"; then
            set_flag flag_137 1
            log_append "[TWGCB-01-012-0137][FIX] changed owner of $audit_log_file to root:root"
        else
            set_flag flag_137 0
            log_append "[TWGCB-01-012-0137][ERROR] failed to chown $audit_log_file"
        fi
    fi
fi
# ======================================
...
if [ $flag_138 -eq 0 ]; then
    if [ -f "$audit_log_file" ]; then
        if chmod 600 "$audit_log_file"; then
            set_flag flag_138 1
            log_append "[TWGCB-01-012-0138][FIX] changed permissions of $audit_log_file to 600"
        else
            set_flag flag_138 0
            log_append "[TWGCB-01-012-0138][ERROR] failed to chmod $audit_log_file"
        fi
    fi
fi
# ======================================
...
if [ $flag_139 -eq 0 ]; then
    if [ -d "$audit_log_dir" ]; then
        if chown root:root "$audit_log_dir"; then
            set_flag flag_139 1
            log_append "[TWGCB-01-012-0139][FIX] changed owner of $audit_log_dir to root:root"
        else
            set_flag flag_139 0
            log_append "[TWGCB-01-012-0139][ERROR] failed to chown $audit_log_dir"
        fi
    fi
fi
# ======================================
...
if [ $flag_140 -eq 0 ]; then
    if [ -d "$audit_log_dir" ]; then
        if chmod 700 "$audit_log_dir"; then
            set_flag flag_140 1
            log_append "[TWGCB-01-012-0140][FIX] changed permissions of $audit_log_dir to 700"
        else
            set_flag flag_140 0
            log_append "[TWGCB-01-012-0140][ERROR] failed to chmod $audit_log_dir"
        fi
    fi
fi
# ======================================
...
if [ $flag_141 -eq 0 ]; then
    ...
    if [ -f "$audit_rules_file" ]; then
        if chmod 600 "$audit_rules_file"; then
            set_flag flag_141 1
            log_append "[TWGCB-01-012-0141][FIX] changed permissions of $audit_rules_file to 600"
        else
            set_flag flag_141 0
            log_append "[TWGCB-01-012-0141][ERROR] failed to chmod $audit_rules_file"
        fi
    fi
fi
# ======================================
...
if [ $flag_142 -eq 0 ]; then
    if chmod 640 /etc/audit/auditd.conf; then
        set_flag flag_142 1
        log_append "[TWGCB-01-012-0142][FIX] changed permissions of /etc/audit/auditd.conf to 640"
    else
        set_flag flag_142 0
        log_append "[TWGCB-01-012-0142][ERROR] failed to chmod /etc/audit/auditd.conf"
    fi
fi
# ======================================
# TWGCB-01-012-0143
    ...
    for tool in $audit_tools; do
        ...
        if [ $(( 8#${perm: -3} & ~8#750 & 8#777 )) -ne 0 ]; then
            if chmod 750 "$tool"; then
                log_append "[TWGCB-01-012-0143][FIX] changed permissions of $tool to 750"
            else
                log_append "[TWGCB-01-012-0143][ERROR] failed to chmod $tool"
                fail143=1
            fi
        fi
    done
    ...
    for tool in $audit_tools; do
        ...
        if [ "$owner" != "root:root" ]; then
            if chown root:root "$tool"; then
                log_append "[TWGCB-01-012-0144][FIX] changed owner of $tool to root:root"
            else
                log_append "[TWGCB-01-012-0144][ERROR] failed to chown $tool"
                fail144=1
            fi
        fi
    done
        ...
        if [ -f "$aide_conf" ]; then
            ...
            for tool in /sbin/auditctl /sbin/aureport /sbin/ausearch /sbin/autrace /sbin/auditd /sbin/augenrules; do
                ...
                if ! grep -qF "$tool" "$aide_conf"; then
                    ...
                    log_append "[TWGCB-01-012-0145][FIX] added $tool monitoring to $aide_conf"
                    needs_update=1
                fi
            done
            set_flag flag_145 1
        else
            log_append "[TWGCB-01-012-0145][ERROR] $aide_conf not found"
            set_flag flag_145 0
        fi
    fi
fi
...
if [ $flag_146 -eq 0 ]; then
    ...
    set_flag flag_146 1
    log_append "[TWGCB-01-012-0146][FIX] set max_log_file = 32 in $auditd_conf"
fi
# ======================================
# TWGCB-01-012-0147
...
if [ $flag_147 -eq 0 ]; then
    ...
    set_flag flag_147 1
    log_append "[TWGCB-01-012-0147][FIX] set max_log_file_action = keep_logs in $auditd_conf"
fi
# ======================================
# TWGCB-01-012-0148
# 稽核 sudoers 變更規則
if [ $flag_148 -eq 0 ]; then
    ...
    if ! grep -qF '/etc/sudoers' "$gcb_rules" 2>/dev/null; then
        ...
        log_append "[TWGCB-01-012-0148][FIX] added audit rule: -w /etc/sudoers -p wa -k scope"
        changed148=1
    fi
    if ! grep -qF '/etc/sudoers.d/' "$gcb_rules" 2>/dev/null; then
        echo "-w /etc/sudoers.d/ -p wa -k scope" >> "$gcb_rules"
        log_append "[TWGCB-01-012-0148][FIX] added audit rule: -w /etc/sudoers.d/ -p wa -k scope"
        changed148=1
    fi
    if [ $changed148 -eq 1 ]; then
        augenrules --load 2>/dev/null && log_append "[TWGCB-01-012-0148][FIX] reloaded audit rules via augenrules"
    fi
    set_flag flag_148 1
fi
# ======================================
...
if [ $flag_149 -eq 0 ]; then
    ...
    if ! grep -qF '/var/run/faillock/' "$gcb_rules" 2>/dev/null; then
        ...
        log_append "[TWGCB-01-012-0149][FIX] added audit rule: -w /var/run/faillock/ -p wa -k logins"
        changed149=1
    fi
    if ! grep -qF '/var/log/lastlog' "$gcb_rules" 2>/dev/null; then
        echo "-w /var/log/lastlog -p wa -k logins" >> "$gcb_rules"
        log_append "[TWGCB-01-012-0149][FIX] added audit rule: -w /var/log/lastlog -p wa -k logins"
        changed149=1
    fi
    if [ $changed149 -eq 1 ]; then
        augenrules --load 2>/dev/null && log_append "[TWGCB-01-012-0149][FIX] reloaded audit rules via augenrules"
    fi
    set_flag flag_149 1
fi
# ======================================
...
if [ $flag_150 -eq 0 ]; then
    ...
    if ! grep -qF '/var/run/utmp' "$gcb_rules" 2>/dev/null; then
        ...
        log_append "[TWGCB-01-012-0150][FIX] added audit rule: -w /var/run/utmp -p wa -k session"
        changed150=1
    fi
    if ! grep -qF '/var/log/wtmp' "$gcb_rules" 2>/dev/null; then
        echo "-w /var/log/wtmp -p wa -k logins" >> "$gcb_rules"
        log_append "[TWGCB-01-012-0150][FIX] added audit rule: -w /var/log/wtmp -p wa -k logins"
        changed150=1
    fi
    if ! grep -qF '/var/log/btmp' "$gcb_rules" 2>/dev/null; then
        echo "-w /var/log/btmp -p wa -k logins" >> "$gcb_rules"
        log_append "[TWGCB-01-012-0150][FIX] added audit rule: -w /var/log/btmp -p wa -k logins"
        changed150=1
    fi
    if [ $changed150 -eq 1 ]; then
        augenrules --load 2>/dev/null && log_append "[TWGCB-01-012-0150][FIX] reloaded audit rules via augenrules"
    fi
    set_flag flag_150 1
fi
# ======================================
...
if [ $flag_151 -eq 0 ]; then
    ...
    for rule in "${rules_151[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0151][FIX] added audit rule: $rule"
            changed=1
        fi
    done
...
if [ $flag_152 -eq 0 ]; then
    ...
    for rule in "${rules_152[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0152][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_153 -eq 0 ]; then
    ...
    for rule in "${rules_153[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0153][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_154 -eq 0 ]; then
    ...
    for rule in "${rules_154[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0154][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_155 -eq 0 ]; then
    ...
    for rule in "${rules_155[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0155][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_156 -eq 0 ]; then
    ...
    for rule in "${rules_156[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0156][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_157 -eq 0 ]; then
    ...
    for rule in "${rules_157[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0157][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_158 -eq 0 ]; then
    ...
    set_flag flag_158 1
    log_append "[TWGCB-01-012-0158][FIX] generated privileged command audit rules in $priv_rules"
fi
# ======================================
# TWGCB-01-012-0159
# 稽核檔案刪除操作規則
if [ $flag_159 -eq 0 ]; then
    ...
    for rule in "${rules_159[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0159][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_160 -eq 0 ]; then
    ...
    for rule in "${rules_160[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0160][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_161 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0161][FIX] added audit rule: $rule"
    fi
    set_flag flag_161 1
fi
# ======================================
...
if [ $flag_162 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0162][FIX] added audit rule: $rule"
    fi
    set_flag flag_162 1
fi
# ======================================
...
if [ $flag_163 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0163][FIX] added audit rule: $rule"
    fi
    set_flag flag_163 1
fi
# ======================================
...
if [ $flag_164 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0164][FIX] added audit rule: $rule"
    fi
    set_flag flag_164 1
fi
# ======================================
...
if [ $flag_165 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0165][FIX] added audit rule: $rule"
    fi
    set_flag flag_165 1
fi
# ======================================
...
if [ $flag_166 -eq 0 ]; then
    ...
    for rule in "${rules_166[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0166][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_167 -eq 0 ]; then
    ...
    for rule in "${rules_167[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0167][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_168 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0168][FIX] added audit rule: $rule"
    fi
    set_flag flag_168 1
fi
# ======================================
...
if [ $flag_169 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0169][FIX] added audit rule: $rule"
    fi
    set_flag flag_169 1
fi
# ======================================
...
if [ $flag_170 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0170][FIX] added audit rule: $rule"
    fi
    set_flag flag_170 1
fi
# ======================================
...
if [ $flag_171 -eq 0 ]; then
    ...
    if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
        echo "$rule" >> "$gcb_rules"
        augenrules --load 2>/dev/null
        log_append "[TWGCB-01-012-0171][FIX] added audit rule: $rule"
    fi
    set_flag flag_171 1
fi
# ======================================
...
if [ $flag_172 -eq 0 ]; then
    ...
    for rule in "${rules_172[@]}"; do
        if ! grep -qF "$rule" "$gcb_rules" 2>/dev/null; then
            echo "$rule" >> "$gcb_rules"
            log_append "[TWGCB-01-012-0172][FIX] added audit rule: $rule"
            changed=1
        fi
    done
    [ $changed -eq 1 ] && augenrules --load 2>/dev/null
...
if [ $flag_173 -eq 0 ]; then
    ...
    if ! grep -qF -- '--loginuid-immutable' "$immutable_rules" 2>/dev/null; then
        ...
        log_append "[TWGCB-01-012-0173][FIX] added --loginuid-immutable to $immutable_rules"
    fi
    if ! grep -qE '^\s*-e\s+2' "$immutable_rules" 2>/dev/null; then
        echo "-e 2" >> "$immutable_rules"
        log_append "[TWGCB-01-012-0173][FIX] added -e 2 to $immutable_rules (reboot required to activate)"
    fi
    augenrules --load 2>/dev/null
    set_flag flag_173 1
fi
...
if [ $flag_174 -eq 0 ]; then
    if dnf install -y rsyslog 2>/dev/null; then
        set_flag flag_174 1
        log_append "[TWGCB-01-012-0174][FIX] installed rsyslog"
    else
        set_flag flag_174 0
        log_append "[TWGCB-01-012-0174][ERROR] failed to install rsyslog"
    fi
fi
# ======================================
# TWGCB-01-012-0175
...
if [ $flag_175 -eq 0 ]; then
    if systemctl --now enable rsyslog 2>/dev/null; then
        set_flag flag_175 1
        log_append "[TWGCB-01-012-0175][FIX] enabled and started rsyslog"
    else
        set_flag flag_175 0
        log_append "[TWGCB-01-012-0175][ERROR] failed to enable rsyslog"
    fi
fi
# ======================================
# TWGCB-01-012-0176
...
if [ $flag_176 -eq 0 ]; then
    ...
    set_flag flag_176 1
    log_append "[TWGCB-01-012-0176][FIX] set FileCreateMode 0640 in $rsyslog_conf"
fi
# ======================================
# TWGCB-01-012-0177
...
if [ $flag_177 -eq 0 ]; then
    ...
    if ! grep -rqsE 'auth\.\*.*authpriv\.\*|authpriv\.\*.*auth\.\*' /etc/rsyslog.conf /etc/rsyslog.d/ 2>/dev/null; then
        ...
        systemctl restart rsyslog 2>/dev/null
        log_append "[TWGCB-01-012-0177][FIX] added auth logging config to $gcb_rsyslog"
    fi
    set_flag flag_177 1
fi
# ======================================
...
if [ "${flag_178:-2}" -eq 0 ]; then
    if [ -f /var/log/messages ]; then
        if chown root:root /var/log/messages; then
            set_flag flag_178 1
            log_append "[TWGCB-01-012-0178][FIX] changed owner of /var/log/messages to root:root"
        else
            set_flag flag_178 0
            log_append "[TWGCB-01-012-0178][ERROR] failed to chown /var/log/messages"
        fi
    fi
fi
# ======================================
...
if [ $flag_179 -eq 0 ]; then
    if chown root:root /var/log; then
        set_flag flag_179 1
        log_append "[TWGCB-01-012-0179][FIX] changed owner of /var/log to root:root"
    else
        set_flag flag_179 0
        log_append "[TWGCB-01-012-0179][ERROR] failed to chown /var/log"
    fi
fi
# ======================================
# TWGCB-01-012-0180
...
if [ $flag_180 -eq 0 ]; then
    ...
    set_flag flag_180 1
    log_append "[TWGCB-01-012-0180][FIX] set ForwardToSyslog=yes in $journald_conf"
fi
# ======================================
# TWGCB-01-012-0181
# 設定 journald 記錄檔壓縮
if [ $flag_181 -eq 0 ]; then
    ...
    systemctl restart systemd-journald 2>/dev/null
    set_flag flag_181 1
    log_append "[TWGCB-01-012-0181][FIX] set Compress=yes in $journald_conf"
fi
# ======================================
# TWGCB-01-012-0182
# 設定 journald 持久化存儲
if [ $flag_182 -eq 0 ]; then
    ...
    systemctl restart systemd-journald 2>/dev/null
    set_flag flag_182 1
    log_append "[TWGCB-01-012-0182][FIX] set Storage=persistent in $journald_conf"
fi
...
if [ $flag_185 -eq 0 ]; then
    if dnf install -y libselinux 2>/dev/null; then
        set_flag flag_185 1
        log_append "[TWGCB-01-012-0185][FIX] installed libselinux"
    else
        set_flag flag_185 0
        log_append "[TWGCB-01-012-0185][ERROR] failed to install libselinux"
    fi
fi
# ======================================
# TWGCB-01-012-0186
...
if [ $flag_192 -eq 0 ]; then
    ...
    set_flag flag_192 1
    log_append "[TWGCB-01-012-0192][FIX] enabled crond service"
fi
...
if [ $flag_193 -eq 0 ]; then
    ...
    set_flag flag_193 1
    log_append "[TWGCB-01-012-0193][FIX] set /etc/crontab owner to root:root"
fi
...
if [ $flag_194 -eq 0 ]; then
    ...
    set_flag flag_194 1
    log_append "[TWGCB-01-012-0194][FIX] set /etc/crontab permissions to 600"
fi
...
if [ $flag_195 -eq 0 ]; then
    ...
    set_flag flag_195 1
    log_append "[TWGCB-01-012-0195][FIX] set /etc/cron.hourly owner to root:root"
fi
...
if [ $flag_196 -eq 0 ]; then
    ...
    set_flag flag_196 1
    log_append "[TWGCB-01-012-0196][FIX] set /etc/cron.hourly permissions to 700"
fi
...
if [ $flag_197 -eq 0 ]; then
    ...
    set_flag flag_197 1
    log_append "[TWGCB-01-012-0197][FIX] set /etc/cron.daily owner to root:root"
fi
...
if [ $flag_198 -eq 0 ]; then
    ...
    set_flag flag_198 1
    log_append "[TWGCB-01-012-0198][FIX] set /etc/cron.daily permissions to 700"
fi
...
if [ $flag_199 -eq 0 ]; then
    ...
    set_flag flag_199 1
    log_append "[TWGCB-01-012-0199][FIX] set /etc/cron.weekly owner to root:root"
fi
...
if [ $flag_200 -eq 0 ]; then
    ...
    set_flag flag_200 1
    log_append "[TWGCB-01-012-0200][FIX] set /etc/cron.weekly permissions to 700"
fi
...
if [ $flag_201 -eq 0 ]; then
    ...
    set_flag flag_201 1
    log_append "[TWGCB-01-012-0201][FIX] set /etc/cron.monthly owner to root:root"
fi
...
if [ $flag_202 -eq 0 ]; then
    if chmod 700 /etc/cron.monthly; then
        set_flag flag_202 1
        log_append "[TWGCB-01-012-0202][FIX] changed permissions of /etc/cron.monthly to 700"
    else
        set_flag flag_202 0
        log_append "[TWGCB-01-012-0202][ERROR] failed to chmod /etc/cron.monthly"
    fi
fi
...
if [ $flag_203 -eq 0 ]; then
    if chown root:root /etc/cron.d; then
        set_flag flag_203 1
        log_append "[TWGCB-01-012-0203][FIX] changed owner of /etc/cron.d to root:root"
    else
        set_flag flag_203 0
        log_append "[TWGCB-01-012-0203][ERROR] failed to chown /etc/cron.d"
    fi
fi
...
if [ $flag_204 -eq 0 ]; then
    if chmod 700 /etc/cron.d; then
        set_flag flag_204 1
        log_append "[TWGCB-01-012-0204][FIX] changed permissions of /etc/cron.d to 700"
    else
        set_flag flag_204 0
        log_append "[TWGCB-01-012-0204][ERROR] failed to chmod /etc/cron.d"
    fi
fi
...
if [ $flag_205 -eq 0 ]; then
    ...
    set_flag flag_205 1
    log_append "[TWGCB-01-012-0205][FIX] removed cron.deny/at.deny, created cron.allow/at.allow with root ownership"
fi
...
if [ $flag_206 -eq 0 ]; then
    ...
    set_flag flag_206 1
    log_append "[TWGCB-01-012-0206][FIX] set permissions of cron.allow and at.allow to 600"
fi
...
if [ $flag_207 -eq 0 ]; then
    ...
    if ! grep -rqsE 'cron\.\*' /etc/rsyslog.conf /etc/rsyslog.d/ 2>/dev/null; then
        ...
        systemctl restart rsyslog 2>/dev/null
        log_append "[TWGCB-01-012-0207][FIX] added cron logging to $gcb_rsyslog"
    fi
    set_flag flag_207 1
fi
...
if [ $flag_208 -eq 0 ]; then
    ...
    set_flag flag_208 1
    log_append "[TWGCB-01-012-0208][FIX] set Retry=3 in $pwq_conf"
fi
...
if [ $flag_209 -eq 0 ]; then
    log_append "[TWGCB-01-012-0209][IGNORE] 交換機需使用 root 權限管理，enforce_for_root 不適用，請評估後手動設定"
fi
...
if [ $flag_210 -eq 0 ]; then
    ...
    set_flag flag_210 1
    log_append "[TWGCB-01-012-0210][FIX] set minlen=12 in pwquality.conf and PASS_MIN_LEN=12 in login.defs"
fi
...
if [ $flag_211 -eq 0 ]; then
    ...
    set_flag flag_211 1
    log_append "[TWGCB-01-012-0211][FIX] set minclass=4 in $pwq_conf"
fi
...
if [ $flag_212 -eq 0 ]; then
    ...
    set_flag flag_212 1
    log_append "[TWGCB-01-012-0212][FIX] set dcredit=-1 in $pwq_conf"
fi
...
if [ $flag_213 -eq 0 ]; then
    ...
    set_flag flag_213 1
    log_append "[TWGCB-01-012-0213][FIX] set ucredit=-1 in $pwq_conf"
fi
...
if [ $flag_214 -eq 0 ]; then
    ...
    set_flag flag_214 1
    log_append "[TWGCB-01-012-0214][FIX] set lcredit=-1 in $pwq_conf"
fi
...
if [ $flag_215 -eq 0 ]; then
    ...
    set_flag flag_215 1
    log_append "[TWGCB-01-012-0215][FIX] set ocredit=-1 in $pwq_conf"
fi
...
if [ $flag_216 -eq 0 ]; then
    ...
    set_flag flag_216 1
    log_append "[TWGCB-01-012-0216][FIX] set difok=3 in $pwq_conf"
fi
...
if [ $flag_217 -eq 0 ]; then
    ...
    set_flag flag_217 1
    log_append "[TWGCB-01-012-0217][FIX] set maxclassrepeat=4 in $pwq_conf"
fi
...
if [ $flag_218 -eq 0 ]; then
    ...
    set_flag flag_218 1
    log_append "[TWGCB-01-012-0218][FIX] set maxrepeat=3 in $pwq_conf"
fi
...
if [ $flag_219 -eq 0 ]; then
    ...
    set_flag flag_219 1
    log_append "[TWGCB-01-012-0219][FIX] set dictcheck=1 in $pwq_conf"
fi
...
if [ $flag_220 -eq 0 ]; then
    ...
    set_flag flag_220 1
    log_append "[TWGCB-01-012-0220][FIX] set deny=5 in $flk_conf"
fi
...
if [ $flag_221 -eq 0 ]; then
    ...
    set_flag flag_221 1
    log_append "[TWGCB-01-012-0221][FIX] set unlock_time=900 in $flk_conf"
fi
...
if [ $flag_222 -eq 0 ]; then
    ...
    for FN in system-auth password-auth; do
        ...
        if grep -qE '^\s*password\s+.*(pam_unix|pam_pwhistory)\.so.*remember=' "$PTF" 2>/dev/null; then
            ...
            log_append "[TWGCB-01-012-0222][FIX] updated remember=3 in $PTF"
            ...
            log_append "[TWGCB-01-012-0222][FIX] added remember=3 to $PTF"
        fi
    done
...
if [ $flag_223 -eq 0 ]; then
    ...
    if [ -f "$target" ]; then
        if ! grep -qE '^\s*session\s+required\s+pam_lastlog\.so.*showfailed' "$target" 2>/dev/null; then
            ...
            log_append "[TWGCB-01-012-0223][FIX] added pam_lastlog showfailed to $target"
        fi
    fi
    set_flag flag_223 1
fi
...
if [ $flag_224 -eq 0 ]; then
    ...
    set_flag flag_224 1
    log_append "[TWGCB-01-012-0224][FIX] set SHA512 in libuser.conf and login.defs"
fi
...
if [ $flag_225 -eq 0 ]; then
    ...
    set_flag flag_225 1
    log_append "[TWGCB-01-012-0225][FIX] set PASS_MIN_DAYS=1 in login.defs"
fi
...
if [ $flag_226 -eq 0 ]; then
    ...
    set_flag flag_226 1
    log_append "[TWGCB-01-012-0226][FIX] set PASS_WARN_AGE=14 in login.defs"
fi
...
if [ $flag_227 -eq 0 ]; then
    ...
    set_flag flag_227 1
    log_append "[TWGCB-01-012-0227][FIX] set PASS_MAX_DAYS=90 in login.defs"
fi
...
if [ $flag_228 -eq 0 ]; then
    useradd -D -f 30
    set_flag flag_228 1
    log_append "[TWGCB-01-012-0228][FIX] set useradd default INACTIVE=30"
fi
...
if [ $flag_229 -eq 0 ]; then
    ...
    set_flag flag_229 1
    log_append "[TWGCB-01-012-0229][FIX] set FAIL_DELAY=4 in login.defs"
fi
...
if [ $flag_230 -eq 0 ]; then
    ...
    set_flag flag_230 1
    log_append "[TWGCB-01-012-0230][FIX] set CREATE_HOME=yes in login.defs"
fi
...
if [ $flag_231 -eq 0 ]; then
    log_append "[TWGCB-01-012-0231][IGNORE] sudoers 中含 NOPASSWD 或 !authenticate，需手動評估後移除"
fi
...
if [ $flag_232 -eq 0 ]; then
    ...
    set_flag flag_232 1
    log_append "[TWGCB-01-012-0232][FIX] set maxlogins=10 in $lim_conf"
fi
...
if [ $flag_233 -eq 0 ]; then
    if dnf install -y kbd &>/dev/null; then
        set_flag flag_233 1
        log_append "[TWGCB-01-012-0233][FIX] installed kbd package"
    else
        log_append "[TWGCB-01-012-0233][ERROR] failed to install kbd package"
    fi
fi
...
EOF
        ...
        set_flag flag_234 1
        log_append "[TWGCB-01-012-0234][FIX] set GNOME screensaver lock-enabled=true"
    else
        log_append "[TWGCB-01-012-0234][IGNORE] dconf not installed (GNOME not present)"
    fi
fi
...
EOF
        dconf update 2>/dev/null
        set_flag flag_235 1
        log_append "[TWGCB-01-012-0235][FIX] set GNOME idle-delay=900"
    else
        log_append "[TWGCB-01-012-0235][IGNORE] dconf not installed (GNOME not present)"
    fi
fi
...
if [ $flag_236 -eq 0 ]; then
    ...
    if [ -f "$gdm_conf" ]; then
        ...
        set_flag flag_236 1
        log_append "[TWGCB-01-012-0236][FIX] set AutomaticLoginEnable=false in $gdm_conf"
    else
        log_append "[TWGCB-01-012-0236][IGNORE] /etc/gdm/custom.conf not found (GDM not installed)"
    fi
fi
...
if [ $flag_237 -eq 0 ]; then
    ...
    while IFS=: read -r user _ uid _ _ _ shell; do
        ...
        if [ "$shell" != "$nologin_path" ] && [ "$shell" != "/bin/false" ] && [ "$shell" != "/usr/sbin/nologin" ]; then
            ...
            log_append "[TWGCB-01-012-0237][FIX] changed shell of $user to $nologin_path"
        fi
    done < /etc/passwd
    set_flag flag_237 1
fi
...
EOF
    set_flag flag_238 1
    log_append "[TWGCB-01-012-0238][FIX] set TMOUT=900 in $tmout_file"
fi
...
EOF
        dconf update 2>/dev/null
        set_flag flag_239 1
        log_append "[TWGCB-01-012-0239][FIX] set dconf locks for GNOME screensaver"
    else
        log_append "[TWGCB-01-012-0239][IGNORE] dconf not installed (GNOME not present)"
    fi
fi
...
if [ $flag_240 -eq 0 ]; then
    ...
    set_flag flag_240 1
    log_append "[TWGCB-01-012-0240][FIX] set root primary group to GID 0"
fi
...
EOF
    set_flag flag_241 1
    log_append "[TWGCB-01-012-0241][FIX] set umask 027 in $umask_file"
fi
...
if [ $flag_242 -eq 0 ]; then
    ...
    set_flag flag_242 1
    log_append "[TWGCB-01-012-0242][FIX] set UMASK=027 in login.defs"
fi
...
if [ $flag_243 -eq 0 ]; then
    ...
    if [ -f "$su_pam" ]; then
        ...
        set_flag flag_243 1
        log_append "[TWGCB-01-012-0243][FIX] added pam_wheel.so use_uid to $su_pam"
    fi
fi
...
if [ $flag_244 -eq 0 ]; then
    if dnf install -y firewalld &>/dev/null; then
        set_flag flag_244 1
        log_append "[TWGCB-01-012-0244][FIX] installed firewalld"
    else
        log_append "[TWGCB-01-012-0244][ERROR] failed to install firewalld"
    fi
fi
...
if [ $flag_245 -eq 0 ]; then
    ...
    set_flag flag_245 1
    log_append "[TWGCB-01-012-0245][FIX] enabled firewalld service"
fi
...
if [ $flag_246 -eq 0 ]; then
    ...
    set_flag flag_246 1
    log_append "[TWGCB-01-012-0246][FIX] disabled and masked iptables and ip6tables"
fi
...
if [ $flag_247 -eq 0 ]; then
    ...
    set_flag flag_247 1
    log_append "[TWGCB-01-012-0247][FIX] disabled and masked nftables"
fi
...
if [ $flag_248 -eq 0 ]; then
    if rpm -q firewalld &>/dev/null && systemctl is-active firewalld &>/dev/null; then
        ...
        set_flag flag_248 1
        log_append "[TWGCB-01-012-0248][FIX] set firewalld default zone to public"
    fi
fi
...
if [ $flag_249 -eq 0 ]; then
    log_append "[TWGCB-01-012-0249][IGNORE] 本環境使用 firewalld，nftables 項目不適用，請評估後手動設定"
fi
...
if [ $flag_250 -eq 0 ]; then
    log_append "[TWGCB-01-012-0250][IGNORE] 本環境使用 firewalld，nftables 項目不適用，請評估後手動設定"
fi
...
if [ $flag_251 -eq 0 ]; then
    log_append "[TWGCB-01-012-0251][IGNORE] 本環境使用 firewalld，nftables 項目不適用，請評估後手動設定"
fi
...
if [ $flag_252 -eq 0 ]; then
    log_append "[TWGCB-01-012-0252][IGNORE] 本環境使用 firewalld，nftables 項目不適用，請評估後手動設定"
fi
...
if [ $flag_253 -eq 0 ]; then
    log_append "[TWGCB-01-012-0253][IGNORE] 本環境使用 firewalld，nftables 項目不適用，請評估後手動設定"
fi

# ======================================
# SSH設定區段：先完成所有設定變更，最後統一重啟sshd
# 注意：RHEL 9 的 sshd_config.d/ drop-in 檔案優先於主設定檔，
#       使用 00-gcb.conf 確保 GCB 設定排序在最前面
SSHD_CONF="/etc/ssh/sshd_config"
SSHD_GCB_CONF="/etc/ssh/sshd_config.d/00-gcb.conf"
sshd_changed=0

# 初始化 00-gcb.conf (若不存在)
if [ ! -f "$SSHD_GCB_CONF" ]; then
    echo "# TWGCB-01-012 GCB Security Hardening - SSH Settings" > "$SSHD_GCB_CONF"
    chmod 600 "$SSHD_GCB_CONF"
fi

# 函式：在 00-gcb.conf 中設定或更新某個 sshd_config 參數
set_sshd_param() {
    local param="$1"
    local value="$2"
    if grep -qiE "^[[:space:]]*${param}[[:space:]]" "$SSHD_GCB_CONF" 2>/dev/null; then
        sed -i "s|^[[:space:]]*${param}[[:space:]].*|${param} ${value}|i" "$SSHD_GCB_CONF"
    else
        echo "${param} ${value}" >> "$SSHD_GCB_CONF"
    fi
}
...
if [ $flag_254 -eq 0 ]; then
    ...
    set_flag flag_254 1
    log_append "[TWGCB-01-012-0254][FIX] enabled sshd service"
fi
...
if [ $flag_255 -eq 0 ]; then
    sed -i 's/^[[:space:]]*Protocol[[:space:]]*1.*/# Protocol 1 disabled by GCB/' "$SSHD_CONF"
    for f in /etc/ssh/sshd_config.d/*.conf; do
        [ -f "$f" ] && sed -i 's/^[[:space:]]*Protocol[[:space:]]*1.*/# Protocol 1 disabled by GCB/' "$f"
    done
    set_flag flag_255 1
    log_append "[TWGCB-01-012-0255][FIX] removed SSH Protocol 1 configuration"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0256
# /etc/ssh/sshd_config檔案所有權設定為root:root
if [ $flag_256 -eq 0 ]; then
    chown root:root "$SSHD_CONF"
    set_flag flag_256 1
    log_append "[TWGCB-01-012-0256][FIX] set /etc/ssh/sshd_config ownership to root:root"
fi

# ======================================
# TWGCB-01-012-0257
# /etc/ssh/sshd_config檔案權限設定為600
if [ $flag_257 -eq 0 ]; then
    chmod 600 "$SSHD_CONF"
    set_flag flag_257 1
    log_append "[TWGCB-01-012-0257][FIX] set /etc/ssh/sshd_config permissions to 600"
fi
...
if [ $flag_258 -eq 0 ]; then
    log_append "[TWGCB-01-012-0258][IGNORE] SSH access restriction requires manual configuration (AllowUsers/AllowGroups/DenyUsers/DenyGroups)"
fi

# ======================================
# TWGCB-01-012-0259
# SSH主機私鑰檔案所有權設定為root:ssh_keys
if [ $flag_259 -eq 0 ]; then
    find /etc/ssh -name "ssh_host_*_key" ! -name "*.pub" -exec chown root:ssh_keys {} \;
    set_flag flag_259 1
    log_append "[TWGCB-01-012-0259][FIX] set SSH host private key ownership to root:ssh_keys"
fi
...
if [ $flag_260 -eq 0 ]; then
    find /etc/ssh -name "ssh_host_*_key" ! -name "*.pub" -exec chmod 640 {} \;
    set_flag flag_260 1
    log_append "[TWGCB-01-012-0260][FIX] set SSH host private key permissions to 640"
fi

# ======================================
# TWGCB-01-012-0261
# SSH主機公鑰檔案所有權設定為root:root
if [ $flag_261 -eq 0 ]; then
    find /etc/ssh -name "ssh_host_*_key.pub" -exec chown root:root {} \;
    set_flag flag_261 1
    log_append "[TWGCB-01-012-0261][FIX] set SSH host public key ownership to root:root"
fi
...
if [ $flag_262 -eq 0 ]; then
    ...
    set_flag flag_262 1
    log_append "[TWGCB-01-012-0262][FIX] set SSH host public key permissions to 644"
fi

# ======================================
# TWGCB-01-012-0263
# SSH加密演算法設定為aes-ctr系列
if [ $flag_263 -eq 0 ]; then
    set_sshd_param "Ciphers" "aes128-ctr,aes192-ctr,aes256-ctr"
    set_flag flag_263 1
    log_append "[TWGCB-01-012-0263][FIX] set SSH Ciphers to aes128-ctr,aes192-ctr,aes256-ctr"
    sshd_changed=1
fi
...
if [ $flag_264 -eq 0 ]; then
    ...
    set_flag flag_264 1
    log_append "[TWGCB-01-012-0264][FIX] set SSH LogLevel to VERBOSE"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0265
# SSH X11Forwarding設定為no
if [ $flag_265 -eq 0 ]; then
    set_sshd_param "X11Forwarding" "no"
    set_flag flag_265 1
    log_append "[TWGCB-01-012-0265][FIX] set SSH X11Forwarding to no"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0266
# SSH MaxAuthTries設定為4
if [ $flag_266 -eq 0 ]; then
    set_sshd_param "MaxAuthTries" "4"
    set_flag flag_266 1
    log_append "[TWGCB-01-012-0266][FIX] set SSH MaxAuthTries to 4"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0267
# SSH IgnoreRhosts設定為yes
if [ $flag_267 -eq 0 ]; then
    set_sshd_param "IgnoreRhosts" "yes"
    set_flag flag_267 1
    log_append "[TWGCB-01-012-0267][FIX] set SSH IgnoreRhosts to yes"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0268
# SSH HostbasedAuthentication設定為no
if [ $flag_268 -eq 0 ]; then
    set_sshd_param "HostbasedAuthentication" "no"
    set_flag flag_268 1
    log_append "[TWGCB-01-012-0268][FIX] set SSH HostbasedAuthentication to no"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0269
# SSH PermitRootLogin (因管理需求，IGNORE)
if [ $flag_269 -eq 0 ]; then
    log_append "[TWGCB-01-012-0269][IGNORE] 因管理需求允許 root SSH 登入，請手動評估後設定"
fi

# ======================================
# TWGCB-01-012-0270
# SSH PermitEmptyPasswords設定為no
if [ $flag_270 -eq 0 ]; then
    set_sshd_param "PermitEmptyPasswords" "no"
    set_flag flag_270 1
    log_append "[TWGCB-01-012-0270][FIX] set SSH PermitEmptyPasswords to no"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0271
# SSH PermitUserEnvironment設定為no
if [ $flag_271 -eq 0 ]; then
    set_sshd_param "PermitUserEnvironment" "no"
    set_flag flag_271 1
    log_append "[TWGCB-01-012-0271][FIX] set SSH PermitUserEnvironment to no"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0272
# SSH逾時時間設定ClientAliveInterval=600, ClientAliveCountMax=1
if [ $flag_272 -eq 0 ]; then
    set_sshd_param "ClientAliveInterval" "600"
    set_sshd_param "ClientAliveCountMax" "1"
    set_flag flag_272 1
    log_append "[TWGCB-01-012-0272][FIX] set SSH ClientAliveInterval=600 ClientAliveCountMax=1"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0273
# SSH LoginGraceTime設定為60
if [ $flag_273 -eq 0 ]; then
    set_sshd_param "LoginGraceTime" "60"
    set_flag flag_273 1
    log_append "[TWGCB-01-012-0273][FIX] set SSH LoginGraceTime to 60"
    sshd_changed=1
fi
...
if [ $flag_274 -eq 0 ]; then
    ...
    set_flag flag_274 1
    log_append "[TWGCB-01-012-0274][FIX] set SSH UsePAM to yes"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0275
# SSH AllowTcpForwarding設定為no
if [ $flag_275 -eq 0 ]; then
    set_sshd_param "AllowTcpForwarding" "no"
    set_flag flag_275 1
    log_append "[TWGCB-01-012-0275][FIX] set SSH AllowTcpForwarding to no"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0276
# SSH MaxStartups設定為10:30:60
if [ $flag_276 -eq 0 ]; then
    set_sshd_param "MaxStartups" "10:30:60"
    set_flag flag_276 1
    log_append "[TWGCB-01-012-0276][FIX] set SSH MaxStartups to 10:30:60"
    sshd_changed=1
fi
...
if [ $flag_277 -eq 0 ]; then
    ...
    set_flag flag_277 1
    log_append "[TWGCB-01-012-0277][FIX] set SSH MaxSessions to 4"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0278
# SSH StrictModes設定為yes
if [ $flag_278 -eq 0 ]; then
    set_sshd_param "StrictModes" "yes"
    set_flag flag_278 1
    log_append "[TWGCB-01-012-0278][FIX] set SSH StrictModes to yes"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0279
# SSH Compression設定為no
if [ $flag_279 -eq 0 ]; then
    set_sshd_param "Compression" "no"
    set_flag flag_279 1
    log_append "[TWGCB-01-012-0279][FIX] set SSH Compression to no"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0280
# SSH IgnoreUserKnownHosts設定為yes
if [ $flag_280 -eq 0 ]; then
    set_sshd_param "IgnoreUserKnownHosts" "yes"
    set_flag flag_280 1
    log_append "[TWGCB-01-012-0280][FIX] set SSH IgnoreUserKnownHosts to yes"
    sshd_changed=1
fi

# ======================================
# TWGCB-01-012-0281
# SSH PrintLastLog設定為yes
if [ $flag_281 -eq 0 ]; then
    set_sshd_param "PrintLastLog" "yes"
    set_flag flag_281 1
    log_append "[TWGCB-01-012-0281][FIX] set SSH PrintLastLog to yes"
    sshd_changed=1
fi

# 套用所有 SSH 設定變更，重啟 sshd
if [ $sshd_changed -eq 1 ]; then
    if sshd -t 2>/dev/null; then
        systemctl restart sshd
        log_append "[SSH][FIX] sshd restarted with new configuration"
    else
        log_append "[SSH][ERROR] sshd config test failed - manual intervention required. Run: sshd -t"
    fi
fi
...
if [ $flag_282 -eq 0 ]; then
    rm -f /etc/shosts.equiv
    set_flag flag_282 1
    log_append "[TWGCB-01-012-0282][FIX] removed /etc/shosts.equiv"
fi
...
if [ $flag_283 -eq 0 ]; then
    find /root /home -name ".shosts" -exec rm -f {} \; 2>/dev/null
    set_flag flag_283 1
    log_append "[TWGCB-01-012-0283][FIX] removed all .shosts files"
fi
...
if [ $flag_284 -eq 0 ]; then
    # Remove CRYPTO_POLICY override from /etc/sysconfig/sshd
    if [ -f /etc/sysconfig/sshd ]; then
        sed -i '/^[[:space:]]*CRYPTO_POLICY=/d' /etc/sysconfig/sshd
        log_append "[TWGCB-01-012-0284][FIX] removed CRYPTO_POLICY override from /etc/sysconfig/sshd"
    fi
    # Switch to DEFAULT policy if currently LEGACY
    current_policy=$(update-crypto-policies --show 2>/dev/null)
    if echo "$current_policy" | grep -qiE "LEGACY"; then
        update-crypto-policies --set DEFAULT
        log_append "[TWGCB-01-012-0284][FIX] changed crypto policy from LEGACY to DEFAULT"
    fi
    set_flag flag_284 1
    log_append "[TWGCB-01-012-0284][FIX] SSH crypto policy override disabled"
fi

# ======================================
# TWGCB-01-012-0315
# SSH停用GSSAPI驗證
if [ $flag_315 -eq 0 ]; then
    set_sshd_param "GSSAPIAuthentication" "no"
    if sshd -t 2>/dev/null; then
        systemctl restart sshd
        log_append "[TWGCB-01-012-0315][FIX] set SSH GSSAPIAuthentication to no"
    else
        log_append "[TWGCB-01-012-0315][ERROR] sshd config test failed after GSSAPIAuthentication change"
    fi
    set_flag flag_315 1
fi
...
if [ $flag_285 -eq 0 ]; then
    ...
    set_flag flag_285 1
    log_append "[TWGCB-01-012-0285][FIX] disabled freevxfs filesystem module"
fi
...
if [ $flag_286 -eq 0 ]; then
    ...
    set_flag flag_286 1
    log_append "[TWGCB-01-012-0286][FIX] disabled hfs filesystem module"
fi
...
if [ $flag_287 -eq 0 ]; then
    ...
    set_flag flag_287 1
    log_append "[TWGCB-01-012-0287][FIX] disabled hfsplus filesystem module"
fi
...
if [ $flag_288 -eq 0 ]; then
    ...
    set_flag flag_288 1
    log_append "[TWGCB-01-012-0288][FIX] disabled jffs2 filesystem module"
fi
...
if [ $flag_289 -eq 0 ]; then
    ...
    set_flag flag_289 1
    log_append "[TWGCB-01-012-0289][FIX] disabled afs filesystem module"
fi
...
if [ $flag_290 -eq 0 ]; then
    ...
    set_flag flag_290 1
    log_append "[TWGCB-01-012-0290][FIX] disabled ceph filesystem module"
fi
...
if [ $flag_291 -eq 0 ]; then
    ...
    set_flag flag_291 1
    log_append "[TWGCB-01-012-0291][FIX] disabled cifs filesystem module"
fi
...
if [ $flag_292 -eq 0 ]; then
    ...
    set_flag flag_292 1
    log_append "[TWGCB-01-012-0292][FIX] disabled exfat filesystem module"
fi

# ======================================
# TWGCB-01-012-0293
# 停用ext檔案系統
if [ $flag_293 -eq 0 ]; then
    echo "install ext /bin/true" > /etc/modprobe.d/ext.conf
    echo "blacklist ext" >> /etc/modprobe.d/ext.conf
    set_flag flag_293 1
    log_append "[TWGCB-01-012-0293][FIX] disabled ext filesystem module"
fi

# ======================================
# TWGCB-01-012-0294
# 停用fat檔案系統
if [ $flag_294 -eq 0 ]; then
    echo "install fat /bin/true" > /etc/modprobe.d/fat.conf
    echo "blacklist fat" >> /etc/modprobe.d/fat.conf
    set_flag flag_294 1
    log_append "[TWGCB-01-012-0294][FIX] disabled fat filesystem module"
fi

# ======================================
# TWGCB-01-012-0295
# 停用fscache檔案系統
if [ $flag_295 -eq 0 ]; then
    echo "install fscache /bin/true" > /etc/modprobe.d/fscache.conf
    echo "blacklist fscache" >> /etc/modprobe.d/fscache.conf
    set_flag flag_295 1
    log_append "[TWGCB-01-012-0295][FIX] disabled fscache filesystem module"
fi

# ======================================
# TWGCB-01-012-0296
# 停用fuse檔案系統
if [ $flag_296 -eq 0 ]; then
    echo "install fuse /bin/true" > /etc/modprobe.d/fuse.conf
    echo "blacklist fuse" >> /etc/modprobe.d/fuse.conf
    set_flag flag_296 1
    log_append "[TWGCB-01-012-0296][FIX] disabled fuse filesystem module"
fi

# ======================================
# TWGCB-01-012-0297
# 停用gfs2檔案系統
if [ $flag_297 -eq 0 ]; then
    echo "install gfs2 /bin/true" > /etc/modprobe.d/gfs2.conf
    echo "blacklist gfs2" >> /etc/modprobe.d/gfs2.conf
    set_flag flag_297 1
    log_append "[TWGCB-01-012-0297][FIX] disabled gfs2 filesystem module"
fi

# ======================================
# TWGCB-01-012-0298
# 停用nfs_common
if [ $flag_298 -eq 0 ]; then
    echo "install nfs /bin/true" > /etc/modprobe.d/nfs_common.conf
    echo "blacklist nfs" >> /etc/modprobe.d/nfs_common.conf
    set_flag flag_298 1
    log_append "[TWGCB-01-012-0298][FIX] disabled nfs (nfs_common) module"
fi

# ======================================
# TWGCB-01-012-0299
# 停用nfsd
if [ $flag_299 -eq 0 ]; then
    echo "install nfsd /bin/true" > /etc/modprobe.d/nfsd.conf
    echo "blacklist nfsd" >> /etc/modprobe.d/nfsd.conf
    set_flag flag_299 1
    log_append "[TWGCB-01-012-0299][FIX] disabled nfsd module"
fi

# ======================================
# TWGCB-01-012-0300
# 停用smbfs_common
if [ $flag_300 -eq 0 ]; then
    ...
    set_flag flag_300 1
    log_append "[TWGCB-01-012-0300][FIX] disabled smbfs_common module"
fi

# ======================================
# TWGCB-01-012-0301
# /etc/shells所有權設定為root:root
if [ $flag_301 -eq 0 ]; then
    chown root:root /etc/shells
    set_flag flag_301 1
    log_append "[TWGCB-01-012-0301][FIX] set /etc/shells ownership to root:root"
fi

# ======================================
# TWGCB-01-012-0302
# /etc/shells權限設定為644
if [ $flag_302 -eq 0 ]; then
    chmod 644 /etc/shells
    set_flag flag_302 1
    log_append "[TWGCB-01-012-0302][FIX] set /etc/shells permissions to 644"
fi

# ======================================
# TWGCB-01-012-0303
# /etc/security/opasswd所有權設定為root:root
if [ $flag_303 -eq 0 ]; then
    for ofile in /etc/security/opasswd /etc/security/opasswd.old; do
        [ -f "$ofile" ] && chown root:root "$ofile"
    done
    set_flag flag_303 1
    log_append "[TWGCB-01-012-0303][FIX] set /etc/security/opasswd files ownership to root:root"
fi

# ======================================
# TWGCB-01-012-0304
# /etc/security/opasswd權限設定為600
if [ $flag_304 -eq 0 ]; then
    for ofile in /etc/security/opasswd /etc/security/opasswd.old; do
        [ -f "$ofile" ] && chmod 600 "$ofile"
    done
    set_flag flag_304 1
    log_append "[TWGCB-01-012-0304][FIX] set /etc/security/opasswd files permissions to 600"
fi

# ======================================
# TWGCB-01-012-0305
# 移除/etc/shells中的nologin項目
if [ $flag_305 -eq 0 ]; then
    sed -i '/nologin/d' /etc/shells
    set_flag flag_305 1
    log_append "[TWGCB-01-012-0305][FIX] removed nologin entries from /etc/shells"
fi

# ======================================
# TWGCB-01-012-0306
# chrony設定OPTIONS="-F 2"
if [ $flag_306 -eq 0 ]; then
    if [ -f /etc/sysconfig/chronyd ]; then
        if grep -qE "^[[:space:]]*OPTIONS=" /etc/sysconfig/chronyd; then
            sed -i 's/^[[:space:]]*OPTIONS=.*/OPTIONS="-F 2"/' /etc/sysconfig/chronyd
        else
    ...
    set_flag flag_306 1
    log_append "[TWGCB-01-012-0306][FIX] set chronyd OPTIONS=-F 2 to restrict privileges"
fi

# ======================================
# TWGCB-01-012-0307
# 設定ptrace限制模式 kernel.yama.ptrace_scope=1
if [ $flag_307 -eq 0 ]; then
    sysctl -w kernel.yama.ptrace_scope=1 2>/dev/null
    if ! grep -rqE "^kernel.yama.ptrace_scope[[:space:]]*=[[:space:]]*1" /etc/sysctl.conf /etc/sysctl.d/ 2>/dev/null; then
        echo "kernel.yama.ptrace_scope = 1" >> /etc/sysctl.d/60-gcb-ptrace.conf
    fi
    set_flag flag_307 1
    log_append "[TWGCB-01-012-0307][FIX] set kernel.yama.ptrace_scope=1"
fi

# ======================================
# TWGCB-01-012-0308
# 設定rsyslog logrotate
if [ $flag_308 -eq 0 ]; then
...
EOF
    ...
    set_flag flag_308 1
    log_append "[TWGCB-01-012-0308][FIX] created rsyslog logrotate configuration"
fi

# ======================================
# TWGCB-01-012-0309
# root umask設定為027
if [ $flag_309 -eq 0 ]; then
    for rcfile in /root/.bash_profile /root/.bashrc; do
        if [ -f "$rcfile" ]; then
            if grep -qE "^[[:space:]]*umask" "$rcfile"; then
                sed -i 's/^[[:space:]]*umask.*/umask 027/' "$rcfile"
            else
                echo "umask 027" >> "$rcfile"
            fi
        else
            echo "umask 027" > "$rcfile"
        fi
    ...
    set_flag flag_309 1
    log_append "[TWGCB-01-012-0309][FIX] set root umask to 027 in .bash_profile and .bashrc"
fi

# ======================================
# TWGCB-01-012-0310
# root帳號鎖定時間需設定60秒以上(even_deny_root + root_unlock_time=60)
if [ $flag_310 -eq 0 ]; then
    FAILLOCK_CONF="/etc/security/faillock.conf"
    if ! grep -qE "^[[:space:]]*even_deny_root" "$FAILLOCK_CONF" 2>/dev/null; then
        echo "even_deny_root" >> "$FAILLOCK_CONF"
    fi
    if grep -qE "^[[:space:]]*root_unlock_time[[:space:]]*=" "$FAILLOCK_CONF" 2>/dev/null; then
        sed -i 's/^[[:space:]]*root_unlock_time.*/root_unlock_time = 60/' "$FAILLOCK_CONF"
    else
        echo "root_unlock_time = 60" >> "$FAILLOCK_CONF"
    fi
    set_flag flag_310 1
    log_append "[TWGCB-01-012-0310][FIX] configured faillock even_deny_root and root_unlock_time=60"
fi

# ======================================
# TWGCB-01-012-0311
# 設定pwquality maxsequence=3
if [ $flag_311 -eq 0 ]; then
    if grep -qE "^[[:space:]]*maxsequence[[:space:]]*=" /etc/security/pwquality.conf 2>/dev/null; then
        sed -i 's/^[[:space:]]*maxsequence.*/maxsequence = 3/' /etc/security/pwquality.conf
    else
        echo "maxsequence = 3" >> /etc/security/pwquality.conf
    fi
    set_flag flag_311 1
    log_append "[TWGCB-01-012-0311][FIX] set pwquality maxsequence=3"
fi

# ======================================
# TWGCB-01-012-0312
# 啟用without-nullok (移除PAM中的nullok)
if [ $flag_312 -eq 0 ]; then
    for pam_file in /etc/pam.d/system-auth /etc/pam.d/password-auth; do
        [ -f "$pam_file" ] && sed -i 's/\bnullok\b//g' "$pam_file"
    done
    set_flag flag_312 1
    log_append "[TWGCB-01-012-0312][FIX] removed nullok from PAM configuration files"
fi

# ======================================
# TWGCB-01-012-0313
# 需啟用pam_pwquality模組
if [ $flag_313 -eq 0 ]; then
    log_append "[TWGCB-01-012-0313][IGNORE] pam_pwquality should be enabled via authselect profile; verify with: authselect current"
fi

# ======================================
# TWGCB-01-012-0314
# 需啟用pam_unix模組
if [ $flag_314 -eq 0 ]; then
    log_append "[TWGCB-01-012-0314][IGNORE] pam_unix should be enabled via authselect profile; verify with: authselect current"
fi
